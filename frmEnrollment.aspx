<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmEnrollment.aspx.cs" Culture="en-GB" Inherits="frmEnrollment" %>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="thumbnail" style="background-color: #f5f5f5; margin-bottom: 3px !important;">
                            <div class="panel-heading" style="padding: 0px;">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <h3 class="text-danger" style="margin: 0px;">Enrollment</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
	...
	<ContentTemplate>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2 col-md-2 col-sm-2 cpl-xs-10">
                                                        ...
                                                        <asp:Button ID="btnMain" OnClick="btnMain_Click" runat="server" Width="60%" Text="Search D2D"
                                                            CssClass="btn btn-danger pull-left btn-sm " />
                                                    </div>
                                                </div>
                                                <%--</ContentTemplate>
</asp:UpdatePanel>
                                                                        ...
                                                                        <div class="Row" style="width: 100%">
                                                                            <asp:GridView ID="gvnroll" runat="server" CssClass="table table-striped table-bordered table-hover" DataKeyNames="UniqueChildCode" OnRowDataBound="gvnroll_OnRowCommand" AutoGenerateColumns="False" Font-Names="Arial"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Enrollment Status" Visible="true">
                                                                                        <ItemTemplate>
