<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" Culture="en-GB" EnableEventValidation="false"
    CodeFile="frmReportD2dSurvey.aspx.cs" Inherits="frmReportD2dSurvey" %>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-default " style="background-color: #f5f5f5; margin-bottom: 0px !important;">
                    <div class="panel-heading" style="margin-right: 15px; padding: 5px 5px;">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Door To Door Survey
                                        </h3>
                                    </div>
                                </div>
                    ...
                    <ul style="margin: 0px">
                        ...
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LnkDeatild_OnClick" Style="color: gren; color: blue;"
                                Text="Door to Door Survey"></asp:LinkButton>
                        </li>


                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton52" runat="server" OnClick="LnkDeatild1_OnClick" Style="color: gren; color: blue;"
                                Text="Village Completion Status"></asp:LinkButton>
                        </li>
                            ...
                            <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LnkDeatild22_OnClick" Text="Village Summary Report"></asp:LinkButton>
                             ...
                             <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkDeatild222_OnClick" Text="FC Progress Summary"></asp:LinkButton>
                        </li>
                    </ul>
                </div>
            </div>
