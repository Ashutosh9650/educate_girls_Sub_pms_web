<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    Culture="en-GB" CodeFile="frmtblReportsVersion.aspx.cs" Inherits="frmtblReportsVersion" %>
             ...
             <%--   </div>--%>
                <ul class="nav navbar-nav" style="margin: 0px">
                    <li class=" active li-width">
                        <asp:LinkButton ID="Button3" runat="server" Text="Employee Version Check " Style="color: white;"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Employee Name" Visible="true">
                                                                     ...
                                                                     <asp:TemplateField HeaderText="Designation" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblDistddddDate" class="labelGrid" ForeColor="Black" runat="server" Text='<%# Eval("Role") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Block Name" Visible="true">
                                                                     ...
                                                                     <asp:TemplateField HeaderText="Cluster Name" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblBlocClusterName" class="labelGrid" ForeColor="Black" runat="server" Text='<%# Eval("ClusterName") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                     <asp:TemplateField HeaderText="ClusterCode" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblBlocClusterCodee" class="labelGrid" ForeColor="Black" runat="server" Text='<%# Eval("ClusterCode") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>

                                                                    <asp:TemplateField HeaderText="Application Version" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblPanchayatName" class="labelGrid" ForeColor="Black" runat="server"
                                                                                Text='<%# Eval("VersionCodeNo") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                   
                                                                     <asp:TemplateField HeaderText="User Status" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblPanchaeeyatName" class="labelGrid" ForeColor="Black" runat="server"
                                                                                Text='<%# Eval("ActiveStatus") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>

                                                                    <asp:TemplateField HeaderText="Last Sync Date Time" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblPanchayatName" class="labelGrid" ForeColor="Black" runat="server"
                                                                                Text='<%# Eval("LastDate") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                            </asp:GridView>
