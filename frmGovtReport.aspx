<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmGovtReport.aspx.cs" Inherits="frmGovtReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container-fluid">
                        ...
                        <div class="row">
                             ...
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Government Report
                                        </h3>
                                    </div>
                                </div>
        ...
        <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-12 text-left" style="padding-right: 0px; margin-top: 10px">
            <div style="overflow: auto; margin-top: 0px; height: 600px;">
                <div class="thumbnail" style="height: 580PX;">

                    <ul style="margin: 0px">

                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LnkGovernmentReport_OnClick" Style="color: gren; color: blue;" Text="Government Report"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="Button3" runat="server" OnClick="LnkDist_OnClick" Style="color: gren; color: blue;" Text="District Profile Summary "></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkEnrolment_OnClick" Style="color: gren; color: blue;" Text="Enrolment Target & Achv. Raw "></asp:LinkButton>
                        </li>
                        ...
                        <div class="row">
                                ...
                                <div class="row marg search-bg">
                                    <div class="form-horizontal">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-sm-2 " >
                                                <asp:RadioButtonList ID="rblDist" AutoPostBack="true"  OnSelectedIndexChanged="rblBlockType_SelectedIndexChanged"  CssClass="cr-icon" ForeColor="Black" RepeatDirection="Horizontal" runat="server">
                                                    ...
                                                    <label for="email" class="padd linhei" style="padding-top: 2px;">
                                                        ...
                                                        <asp:DropDownList ID="ddlGroup" runat="server" class="form-control">
                                                                ...
                                                                <asp:ListItem Value="2">District Wise </asp:ListItem>
                                                                <asp:ListItem Value="3">Block Wise </asp:ListItem>
                                                    ...
                                                    <asp:DropDownList ID="ddlTpye"  OnSelectedIndexChanged="ddlTpye_SelectedIndexChanged" AutoPostBack="true" runat="server" class="form-control">
                                                               <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                                                                        ...
                                                                        <asp:ListItem Text="Quarter Wise" Value="2"></asp:ListItem>
                                           ...
                                           <div class="col-sm-2 " >
                                                    ...
                                                    <div class="padd CheckBoxListCssClass " style="border:1px solid #c1c1c1"">
                                                        ...
                                                        <div style="overflow: auto; margin-top:1px; height:132px; ">
                                                        ...
                                                        <asp:Label for="email" ID="lblMonth" class="padd linhei" Visible="false"  runat="server" style="padding-top: -13px;">
                                                        Month</asp:Label>
                                                       
                                                    <asp:DropDownList ID="ddlMonth" Visible="false"    runat="server" class="form-control">
                                                               <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                                                                        <asp:ListItem Text="Month Wise " Value="1"></asp:ListItem>
                                                                        <asp:ListItem Text="Quarter Wise" Value="2"></asp:ListItem>
                            ...
                            <div class="col-lg-12 table table-hover " style="padding: 0px;">
                                <asp:Panel ID="pnlMain" Enabled="true" runat="server">
                                    <div class="form-horizontal">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 5px 10px 10px 10px;">
