<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmAnnualReportAgp.aspx.cs" Inherits="frmAnnualReportAgp" %>
                    ...
                    <div class="panel-heading" style="padding: 5px 0px;">
                        <div class="row">
                                ...
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">AGP Annual Plan
                                        </h3>
                                    </div>
                                </div>
                        ...
                        <li >
                           ...
                           <li >
                            <asp:LinkButton ID="LinkButton3" Visible="true" runat="server" Text="Annual Plan Summary"
                                 style="color: blue;" OnClick="LnkAnSummary_OnClick"></asp:LinkButton></li>
                            ...
                            <div id="div-show-new">
                                ...
                                <div class="col-lg-12 table table-hover " style="padding: 0px;">
                                    <asp:Panel ID="pnlMain" Enabled="true" runat="server">
                                        <div class="form-horizontal">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 5px 10px 0px 10px;">
