<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmBeneficiary.aspx.cs" Inherits="Beneficiary" %>
                        ...
                        <div class="row">
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Summary Report
                                        </h3>
                                    </div>
                                </div>
                ...
                <div class="thumbnail" style="height: 570PX;">
                    ...
                    <ul style="margin: 0px">
                        <li class=" active li-width">
                            <asp:LinkButton ID="Button3" runat="server" OnClick="LnkAnnualPlan_OnClick" Style="color: gren; color: blue;" Text="Beneficiary Summary Report"></asp:LinkButton>
                        </li>


                        <li>
                            <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LnkAnnua1_OnClick" Style="color: gren; color: blue;" Text="Project Darpan"></asp:LinkButton>
                        </li>
