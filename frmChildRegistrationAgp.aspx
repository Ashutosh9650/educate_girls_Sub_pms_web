<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmChildRegistrationAgp.aspx.cs" Inherits="frmChildRegistrationAgp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container-fluid">
                        ...
                        <div class="row">
                             ...
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Summar Camp Report
                                        </h3>
                                    </div>
                                </div>
        ...
        <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-12 text-left" style="padding-right: 5px; margin-top: 10px;">
            <div style="overflow: auto; margin-top: 0px; height: 581px;">
                <div class="thumbnail" style="overflow: auto; margin-bottom: 0px; height: 561px;">
                    ...
                    <ul style="margin: 0px">
                        ...
                        <li>
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkAnnualPlanFC_OnClick" Style="color: gren; color: blue;" Text="Child Attendance Old"></asp:LinkButton>
                        </li>

                        <li>
                            <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LnkAnnualPlanFCNew_OnClick" Style="color: gren; color: blue;" Text="Child Attendance"></asp:LinkButton>
                        </li>


                        <li>
                            <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LnkAnnualPl_OnClick" Style="color: gren; color: blue;" Text="Attendance Summary Old "></asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LnkAnnualPl_OnClickNew" Style="color: gren; color: blue;" Text="Attendance Summary "></asp:LinkButton>
                        </li>
                        <li>
                ...
                <div class="panel panel-default" style="margin-bottom: 0px">
                    <div class="form-horizontal">
                        <div class="row">
                            ...
                            <div class="col-lg-12 table table-hover " style="padding: 0px; margin-top: 5px">
