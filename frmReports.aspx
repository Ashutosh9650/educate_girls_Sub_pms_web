<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    Culture="en-GB" CodeFile="frmReports.aspx.cs" Inherits="frmReports" %>
                    ...
                    <ul class="nav navbar-nav" style="margin: 0px">
                        ...
                        <li class="li-width">
                            <asp:LinkButton ID="LinkButton9" Visible="true" runat="server" Text="Ineligible"
                                Style="color: white;" OnClick="btnInEligible_Click"></asp:LinkButton></li>
                            <li class="li-width">
                        ...
                        <li class="li-width">
                            <asp:LinkButton ID="LinkButton13" Visible="true" runat="server" Text="Learning Baseline"
                                Style="color: white;" OnClick="btnLearningBaseline_Click"></asp:LinkButton></li>

                        <li class="li-width">
                            <asp:LinkButton ID="LinkButton8" Visible="true" runat="server" Text="Retention Individual"
