<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="frmGKpChildRegPlus.aspx.cs" Inherits="frmGKpChildRegPlus" %>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">GKP Plus Report
                                        </h3>
                                    </div>
                                </div>
                ...
                <ul style="margin: 0px">
                    ...
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LnkDeatild_OnClick" Style="color: gren; color: blue;"
                            Text="Child Registration"></asp:LinkButton>
                    </li>
                   
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LnkFillingSystem_OnClick" Style="color: gren; color: blue;"
                            Text="Child Attendance"></asp:LinkButton>
                    </li>
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LnkEX_OnClick" Style="color: gren; color: blue;"
                            Text="Assessment Report"></asp:LinkButton>
                    </li>
                   
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkgkSummary_OnClick" Style="color: gren; color: blue;"
                            Text="Formative Assessment Report"></asp:LinkButton>
                    </li>
                      <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton7" runat="server" OnClick="LnkgkSummary_OnClick1" Style="color: gren; color: blue;"
                            Text="Summary Report"></asp:LinkButton>
                    </li>

                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton4" runat="server" Visible="false" OnClick="GKPAssessmentSummary_OnClick" Style="color: gren; color: blue;"
                            Text="Session Update Report"></asp:LinkButton>
                    </li>


                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton8" runat="server" Visible="false"  OnClick="GKPAssessmentAlert1_OnClick" Style="color: gren; color: blue;"
                            Text="Attendance Summary"></asp:LinkButton>
                    </li>
