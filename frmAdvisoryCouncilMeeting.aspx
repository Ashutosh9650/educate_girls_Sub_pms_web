<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmAdvisoryCouncilMeeting.aspx.cs" Inherits="frmAdvisoryCouncilMeeting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Advisory Council Report
                                        </h3>
                                    </div>
                                </div>
        ...
        <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-12 text-left" style="padding-right: 0px; margin-top: 10px">
            <div style="overflow: auto; margin-top: 0px; height: 590px;">
                <div class="thumbnail" style="height: 570PX;">

                    <ul style="margin: 0px">
                        <li class=" active li-width">
                            <asp:LinkButton ID="Button3" runat="server" OnClick="LnkAnnualPlan_OnClick" Style="color: gren; color: blue;" Text="AC Members Profile"></asp:LinkButton>
                        </li>

                        <li>
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkAnnualPlanFC_OnClick" Style="color: gren; color: blue;" Text="Advisory Council Formation"></asp:LinkButton>
                        </li>

                        <li>
                            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LnkAnnualMeeting_OnClick" Style="color: gren; color: blue;" Text="Advisory Council Meeting"></asp:LinkButton>
                        </li>
