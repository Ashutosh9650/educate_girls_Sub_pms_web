<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmCLLSG.aspx.cs" Inherits="frmCLLSG" %>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Community Level LSG
                                        </h3>
                                    </div>
                                </div>
                ...
                <div class="thumbnail" style="height: 565PX;">
                    ...
                    <ul style="margin: 0px">
                        <li class=" active li-width">
                            <asp:LinkButton ID="Button3" runat="server" OnClick="LnkAnnualPlan_OnClick" Style="color: gren; color: blue;" Text="OLD CLLSG Detail Report"></asp:LinkButton>
                        </li>

                        <li>
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkAnnualPlanFC_OnClick" Style="color: gren; color: blue;" Text="OLD CLLSG Summary"></asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LnkALGVnFC_OnClick" Style="color: gren; color: blue;" Text="CL-LSG Girls Registration"></asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="LinkButton6" runat="server" OnClick="Lnk5ffgggfick" Style="color: gren; color: blue;" Text="CL-LSG Attendance summary"></asp:LinkButton>
                        </li>

                        <li>
                            <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LnkALAttC_OnClick" Style="color: gren; color: blue;" Text="CL-LSG Attendance"></asp:LinkButton>
                        </li>

                        <li>
                            <asp:LinkButton ID="LinkButton5" runat="server" OnClick="Lnk5fffick" Style="color: gren; color: blue;" Text="CL-LSG Summery"></asp:LinkButton>
                        </li>
