<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="frmPmsTracker.aspx.cs" Inherits="frmPmsTracker" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Enrollment Tracker Report
                                        </h3>
                                    </div>
                                </div>
                ...
                <div class="thumbnail" style="height: 750PX;">
                    <ul style="margin: 0px">
                        <li class=" active li-width">
                            <asp:LinkButton ID="Button3" runat="server" OnClick="LnkCHild_OnClick" Style="color: gren; color: blue;"
                                Text="School Summaries "></asp:LinkButton>
                        </li>
                        <li>
                        ...
                        <li>
                            <asp:LinkButton ID="LinkButton4" Visible="true" runat="server" onmouseover="SetText1(this, '');"
                                onmouseout="SetText1(this, 'Target monitoring');" Text="Target Monitoring" Style="color: gren; color: blue;"
                                OnClick="LnkChildSummaryTarget_OnClick"></asp:LinkButton></li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LnkDeatild_OnClick" Style="color: gren; color: blue;"
                                Text="Enrolment Details "></asp:LinkButton>
                        </li>

                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton15" runat="server" OnClick="Lnk45Deatild_OnClick" Style="color: gren; color: blue;"
                                Text="Mapping Verification Report"></asp:LinkButton>
                        </li>

                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton11" runat="server" OnClick="LnkDeatild1_OnClick" Style="color: gren; color: blue;"
                                Text="Enrolment Fuzzy Matching"></asp:LinkButton>
                        </li>
                          <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton13" runat="server" OnClick="LnkDeatildddd_OnClick" Style="color: gren; color: blue;"
                                Text="Discrepancies from Contact to Enrolment"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton14" runat="server" OnClick="LnkDeatildddd2_OnClick" Style="color: gren; color: blue;"
                                Text="Enrolment data edit Report"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LnkFillingSystem_OnClick" Style="color: gren; color: blue;"
                                Text="Filing System Details "></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LnkEX_OnClick" Style="color: gren; color: blue;"
                                Text="Exception Report"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton7" Visible="false" runat="server" OnClick="Lnkpf_OnClick" Style="color: gren; color: blue;"
                                Text="Enrolment Summary"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton8" runat="server" Visible="false" OnClick="Lnkpfkj_OnClick" Style="color: gren; color: blue;"
                                Text="Enrolment Quality Alert"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton9" runat="server" OnClick="Lnkpfkj33_OnClick" Style="color: gren; color: blue;"
                                Text="Cluster Performance "></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton10" runat="server" OnClick="Lnkpfkj334_OnClick" Style="color: gren; color: blue;"
                                Text="Village Exit Readiness Report"></asp:LinkButton>
                        </li>
