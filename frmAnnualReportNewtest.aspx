<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmAnnualReportNewtest.aspx.cs" Inherits="frmAnnualReportNewtest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Annual Plan
                                        </h3>
                                    </div>
                                </div>
        ...
        <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-12 text-left" style="padding-right: 0px; margin-top: 10px">
            <div style="overflow: auto; margin-top: 0px; height: 595px;">
                <div class="thumbnail" style="height: 575PX;">

                    <ul style="margin: 0px">
                        <li class=" active li-width">
                            <asp:LinkButton ID="Button3" runat="server" OnClick="LnkAnnualPlan_OnClick" Style="color: gren; color: blue;" Text="Annual Plan Target Sheet "></asp:LinkButton>
                        </li>

                        <%--    <li >
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkAnnualPlanFC_OnClick" style="color: gren;color: blue;" Text="Annual Plan Target FC "
                               ></asp:LinkButton>
                        </li>--%>

                        <li runat="server" id="A1">
                            <asp:LinkButton ID="LinkButton4" Visible="true" runat="server" Text="Annual Plan Detail"
                                Style="color: gren; color: blue;" OnClick="LnkAnnualPlanDe_OnClick"></asp:LinkButton></li>



                        <li>
                            <asp:LinkButton ID="LinkButton3" Visible="true" runat="server" Text="Annual Plan Summary"
                                Style="color: gren; color: blue;" OnClick="LnkAnSummary_OnClick"></asp:LinkButton></li>

                        <li class="li-width">
                            <asp:LinkButton ID="LnkMasterDate" Visible="true" runat="server" Text="Location Master"
                                Style="color: gren; color: blue;" OnClick="LnkMasterData_OnClick"></asp:LinkButton></li>

                        <li class="li-width">
                            <asp:LinkButton ID="LinkButton5" Visible="true" runat="server" Text="Enrollment Target Raw Data"
                                Style="color: gren; color: blue;" OnClick="LnkEnrolment_OnClick"></asp:LinkButton></li>

                        <li class="li-width" runat="server" id="A2">
                            <asp:LinkButton ID="LinkButton6" Visible="true" runat="server" Text="Team Balika Target vs Acheivement"
                                Style="color: gren; color: blue;" OnClick="LnkEnrolment_TbNeed"></asp:LinkButton></li>
                        <li runat="server" id="A3">
                            <asp:LinkButton ID="LinkButton7" Visible="true" runat="server" Text="Enrollment OPs Target"
                                Style="color: gren; color: blue;" OnClick="LnkEnrolment_Hotspot"></asp:LinkButton></li>

                        <li>
                            <asp:LinkButton ID="LinkButton8" Visible="true" runat="server" Text="Approval Process Report"
                                Style="color: gren; color: blue;" OnClick="AnnalPlanExcel_Hotspot"></asp:LinkButton></li>
                        <li runat="server" id="Li1">
                            <asp:LinkButton ID="LinkButton2" Visible="true" runat="server" Text="Annual Plan Quality Alert"
                                Style="color: gren; color: blue;" OnClick="LnkAnSummaryAlter_OnClick"></asp:LinkButton></li>
                            <li>
                            <asp:LinkButton ID="LinkButton9" Visible="true" runat="server" Text="Master Approval Process Report"
                                Style="color: gren; color: blue;" OnClick="AnnalPlanExcel_Hotspottest"></asp:LinkButton></li>
<%--                        <li>  <asp:LinkButton ID="LinkButton10" Visible="true" runat="server" Text="Master GKP Approval Process Report"
                                Style="color: gren; color: blue;" OnClick="AnnalPlanExce1l1_Hotspottest"></asp:LinkButton></li>
                     --%>
                         <li>  <asp:LinkButton ID="LinkButton13" Visible="true" runat="server" Text="Team Bailka  Approval  Report"
                                Style="color: gren; color: blue;" OnClick="AnnalPlanExce66_Hotspottest"></asp:LinkButton></li>

                        <li>  <asp:LinkButton ID="LinkButton10" Visible="true" runat="server" Text="School Boundary Alignment"
                                Style="color: gren; color: blue;" OnClick="AnnalPlanExce66Bounda_Hotspottest"></asp:LinkButton></li>
                        ...
                        <div class="row">
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="row" style="margin-bottom: 15px;">
                                            ...
                                            <div class="col-sm-2 ">
                                                ...
                                                <asp:Label for="email" runat="server" ID="lblPlan" class="padd linhei" Style="padding-top: 2px;">
                                                        Plan Type</asp:Label>

                                                <asp:DropDownList ID="ddlTpye" OnSelectedIndexChanged="ddlTpye_SelectedIndexChanged" AutoPostBack="true" runat="server" class="form-control">
                                                ...
                                                <asp:Label for="email" runat="server" ID="lblGrop" class="padd linhei" Style="padding-top: 5px;">
                                                        Group</asp:Label>
                            ...
                            <div class="col-lg-12 table table-hover " style="padding: 0px;">
                                <asp:Panel ID="pnlMain" Enabled="true" runat="server">
                                    <div class="form-horizontal">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 11px;">
