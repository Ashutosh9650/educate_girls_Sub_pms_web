<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="frmFCPlannerTracker.aspx.cs" Culture="en-GB" Inherits="frmFCPlannerTracker" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Smart Planner Detail Report
                                        </h3>
                                    </div>
                                </div>
                    ...
                    <ul style="margin: 0px">
                        ...
                        <li>
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkChildSummary_OnClick"
                                ...
                                Text="Smart Planner Detail"></asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="LinkButton4" Visible="true" runat="server"
                                 Text="Activity Plan vs Achv" Style="color: gren; color: blue;"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-2 ">
                                                           <label for="email" class="padd linhei" style="padding-top: 1px;">
                                                            ...
                                                            <asp:DropDownList ID="ddlGender"  Visible="false"  OnSelectedIndexChanged="ddlGender_SelectedIndexChanged"
                                                                        AutoPostBack="true" runat="server" class="form-control ">
