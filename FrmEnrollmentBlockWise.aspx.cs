...
public partial class FrmEnrollmentBlockWise : System.Web.UI.Page
{
   ...
   public void LoadDataBlock(string blockName)
    ...
    public DataTable LoadActivtiyAllClusterWise(string userName, string WhereQuery, Int32 Flag, string WhereQuery1)
    {
        ...
        return SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[LoadEnrollmentSealSineClusterBlockWise]", cmdParameters);
    }
    ...
    protected void OOD2Dtargetmet_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/FrmSealSignApproval.aspx?ID=" + lblBlockCode + "," + lblClusterCode + "");
