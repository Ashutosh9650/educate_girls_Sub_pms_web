<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmTeamBalikaAward.aspx.cs" Culture="en-GB" MasterPageFile="~/Site.master"
    Inherits="frmTeamBalikaAward" %>
                                    ...
                                    <div class="panel-heading" style="padding: 5px;">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <h3 class="text-danger" style="margin: 0px;">Team Balika Award </h3>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 " style="padding: 0px">
                                                <button type="button" id="ton-new" class="btn btn-primary" style="float: right; position: relative; margin-right: 15px; right: 1px; color: #fff; background-color: #337ab7; border-color: #2e6da4;">
                                                    <i class="fa fa-bars"></i>
                                                </button>
                                                <%--<input type="image" id="ton-new" class="butt" src="Images/search-not-29.png" title="Search" style="margin-right: 10px;" />--%>
        ...
        <ContentTemplate>--%>
                                            ...
                                            <div class="col-lg-12" style="padding: 10px;">
                                                <asp:Panel ID="pnlMain" Enabled="false" runat="server">
                                                    <div class="form-horizontal">
                                                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="padding: 0px; margin-bottom: -16px;">
                                                            <fieldset class="scheduler-border">
                                                                ...
                                                                <div class="form-group">
                                                                    <asp:Label class="control-label col-sm-4" runat="server" ID="lblDob" Text="Award Date"></asp:Label>
                                                                    <div class="col-sm-8">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <asp:DropDownList ID="ddlCalltype" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCalltype_SelectedIndexChanged" class="form-control">
                                                                            ...
                                                                            <asp:ListItem Value="1">Internal Award </asp:ListItem>
                                                                            <asp:ListItem Value="2">External Award</asp:ListItem>
                                                                            <asp:ListItem Value="3">External Award Nomination</asp:ListItem>
                                                                            <asp:ListItem Value="4">External Scholarship Nomination</asp:ListItem>
                                                                              <asp:ListItem Value="5">External Fellowship Nomination</asp:ListItem>
                                                                ...
                                                                <div class="form-group" id="IScall" runat="server" visible="false">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <asp:DropDownList ID="ddlAwardtype" AutoPostBack="true" OnSelectedIndexChanged="ddlAwardtypee_SelectedIndexChanged" runat="server" class="form-control">
                                                                        </asp:DropDownList>

                                                                    </div>

                                                                </div>
                                                                <div class="form-group" id="IScall1" runat="server" visible="false">
                                                                    <label class="control-label col-sm-4" for="Name">
                                                                        Individual Award Detail
                                                                    </label>
                                                                    <div class="col-sm-8">
                                                                        <asp:TextBox ID="txtIndividual" runat="server" MaxLength="100" TextMode="MultiLine"
                                                                            autocomplete="off" ondrop="return false;" class="form-control TeContact1 " />

                                                                    </div>
                                                                </div>
                                                                <div class="form-group" id="IScall2" runat="server" visible="false">
                                                                    <label class="control-label col-sm-4" for="Name">
                                                                        Award Level
                                                                    </label>
                                                                    <div class="col-sm-8">
                                                                        <asp:DropDownList ID="ddlAwardLevel" runat="server" class="form-control">
                                                                        </asp:DropDownList>
                                                                ...
                                                                <div class="form-group" id="IScall3" runat="server" visible="false">
                                                                    <label class="control-label col-sm-4" for="Name">
                                                                        Award Name</label>
                                                                    <div class="col-sm-8">
                                                                        <asp:TextBox ID="txtAwardName" MaxLength="100" autocomplete="off" ondrop="return false;"
                                                                            runat="server" class="form-control" TextMode="MultiLine" />
