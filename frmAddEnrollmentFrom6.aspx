<%@ Page Language="C#" AutoEventWireup="true"  Culture="en-GB" CodeFile="frmAddEnrollmentFrom6.aspx.cs" Inherits="frmAddEnrollmentFrom6" %>
     ...
     <asp:UpdatePanel runat="server" ID="UpMain">
        <ContentTemplate>
             ...
             <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12  col-xs-12 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 col-xs-offset-0" style="padding-left: -2px;">
                <div class="thumbnail" style="background-color: #f5f5f5;float: left; width: 90%;">
                                    ...
                                    <div class="row marg search-bg">
                                        <div class="form-horizontal">
                                            ...
                                            <div class="row" >
                                                ...
                                                <div id="Div1" class="col-lg-6 col-md-6 col-sm-6 cpl-xs-12" runat="server">
                                                    <div class="form-group">
                                                        <label for="email" class="col-sm-3 padd linhei" >
                                                            School:</label>
...
<div class="col-lg-8 col-md-8col-sm-12 col-xs-12 ">
   ...
   <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtDobDate"
                        ...
                        ValidationGroup="Valid">
                                ...
                                <div class="form-group">
                                      <label class="control-label col-sm-4" for="Name" id="Label10" runat="server">Samgra ID</label>
