<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" Culture="en-GB" AutoEventWireup="true"
    CodeFile="frmAnalysisReport.aspx.cs" Inherits="frmAnalysisReport" %>
        ...
        <div style="width:70%; float:left; height:100%; background-color:Blue; " >
            ...
            <ul class="nav navbar-nav" style="margin: 0px">
                <li class=" active li-width">
                    <asp:LinkButton ID="Button3"  Visible="false" runat="server" Text="Gender and Age wise " style="color: white;" OnClick="btnAge_Click"></asp:LinkButton>
                </li>
                <li class="li-width">
                    <asp:LinkButton ID="ff" Visible="false" runat="server" Text="Social Category " style="color: white;" OnClick="btnSerach_Click"></asp:LinkButton></li>
                <li class="li-width">
                    <asp:LinkButton ID="Button4" Visible="false" runat="server" Text="Education status" style="color: white;" OnClick="Education_Click"></asp:LinkButton></li>
                <li class="li-width">
                    <asp:LinkButton ID="Button2" Visible="false" runat="server" Text="Family Occupation" style="color: white;" OnClick="btnUser_Click"></asp:LinkButton></li>
                <li class="li-width">
                    <asp:LinkButton ID="Button5" Visible="false" runat="server" Text="Grade wise Category" style="color: white;" OnClick="btnGrade_Click"></asp:LinkButton></li>

                    <li class="li-width">
                    <asp:LinkButton ID="LinkButton1" runat="server" Text="Enrollment Plan" style="color: white;" OnClick="btnEnroll_Click"></asp:LinkButton></li>

                    <li class="li-width">
                    <asp:LinkButton ID="LinkButton2" Visible="false" runat="server" Text="Reason Wise"  style="color: white;" OnClick="btnReason_Click"></asp:LinkButton></li>
                <li class="li-width">
                    <asp:LinkButton ID="Button1" Visible="false" runat="server" Text="Report D2D" style="color: white;" OnClick="btnD2d_Click"></asp:LinkButton></li>

                <li class="li-width">
                    <asp:LinkButton ID="LinkButton3" runat="server" Text="Enrollment Analysis " style="color: white;" OnClick="btnAnalayis_Click"></asp:LinkButton></li>
                                                    ...
                                                    <div style=" height: 290px; overflow:auto;  width: 99%;" align="center">
                                                        <div>
                                                            <div class="Row" style="width: 100% ">
                                                                <rsweb:ReportViewer ID="rptD2D" ShowBackButton="true" runat="server" Style="width: 100%; "
