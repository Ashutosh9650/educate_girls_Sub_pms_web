...
public partial class frmAnnualReportAgp : System.Web.UI.Page
{
    ...
    public void FillCVillage()
    {
       string conditions = "";
        ...
        string strQry = "  SELECT VillageCode, dbo.TitleCase(upper(VillageName))  as VillageName FROM mst5VillageAgp where " + conditions + "  order by VillageName   ";
        DataTable dtDistrict = objMain.LoadData(strQry);
    ...
    public void LoadAnnualData2021(int Flag)
    {
        ...
        if (Flag == 2 || Flag == 3)
        {
            if (ddlYear.SelectedIndex > 0)
            {
                conditions += "    where mst5VillageAgp.Fyear = '" + ddlYear.SelectedItem.Text + "' ";

            }
            if (ddlStatecode.Length > 0)
            {
                conditions += " and mst5VillageAgp.StateCode in(" + ddlStatecode + ") ";

            }
            if (ddlDistrict.Length > 0)
            {
                conditions += " and mst5VillageAgp.DistrictCode in(" + ddlDistrict + ") ";
            ...
            if (ddlBlock.Length > 0)
            {
                ...
                conditions += " and mst5VillageAgp.BlockCode in(" + ddlBlock + ") ";


            }
            if (ddlPhan.Length > 0)
            {
                conditions += " and mst5VillageAgp.PanchayatCode in(" + ddlPhan + ") ";
            }
            if (ddlVillage.Length > 0)
            {
                conditions += " and mst5VillageAgp.VillageCode in(" + ddlVillage + ") ";
            }
        }
        ...
        DataSet ds = SqlHelper.GetDataSet(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptAnnaulplaSheet2022AgP]", cmdParameters);
    ...
    private void GenerateExcelNewSUmmary(string FIleName)
    {
        try
        {
            ...
            {
                FIleName = "AGPAnnualPlanDistrictSummary";
            }
            if (Convert.ToInt32(ddlGroup.SelectedValue) == 2)
            {
                FIleName = "AGPAnnualPlanBlockSummary";
            }
            if (Convert.ToInt32(ddlGroup.SelectedValue) == 3)
            {
                FIleName = "AGPAnnualPlanClusterSummary";
            }
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    sw.Write("<tr>");
                    sw.Write("<td colspan='19' ' style='text-align:Center;border:.2pt solid windowtext;'>AGP Annual Plan District Summary </td>");
                    sw.Write("</tr>");
                }
                if (Convert.ToInt32(ddlGroup.SelectedValue) == 2)
                {
                    sw.Write("<tr>");
                    sw.Write("<td colspan='18' ' style='text-align:Center;border:.2pt solid windowtext;'> AGP Annual Plan Block Summary </td>");
                    sw.Write("</tr>");
                }
                if (Convert.ToInt32(ddlGroup.SelectedValue) == 3)
                {
                    sw.Write("<tr>");
                    sw.Write("<td colspan='20' ' style='text-align:Center;border:.2pt solid windowtext;'>AGP Annual Plan Cluster Summary </td>");
                    sw.Write("</tr>");
                }
    ...
    private void GenerateExcelNew2021(string FIleName)
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    HttpContext.Current.Response.Write("<tr>");
                    HttpContext.Current.Response.Write("<td colspan='15' ' style='text-align:Center;border:.2pt solid windowtext;'>AGP Annual Plan-  District Level Planning </td>");
                ...
                if (Convert.ToInt32(ddlTpye.SelectedValue) == 2)
                {
                    ...
                    HttpContext.Current.Response.Write("<tr>");
                    HttpContext.Current.Response.Write("<td colspan='23' ' style='text-align:Center;border:.2pt solid windowtext;'>AGP Annual Plan - Village Level Planning</td>");
    ...
    private void GenerateExcelNewAnnaulDetails(string FIleName)
    {
        try
        {
            ...
            if (Convert.ToInt32(ddlTpye.SelectedValue) == 1)
            {
                FIleName = "AGPAnnualPlanDistrictDetail";
            }
            if (Convert.ToInt32(ddlTpye.SelectedValue) == 2)
            {
                FIleName = "AGPAnnualPlanVillageDetail";
            }
            if (Convert.ToInt32(ddlTpye.SelectedValue) == 3)
            {
                FIleName = "AGPAnnualPlanSchoolDetail";
            }
            DataTable dt = ViewState["D2dUser"] as DataTable;
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    HttpContext.Current.Response.Write("<tr>");
                    HttpContext.Current.Response.Write("<td colspan='17' ' style='text-align:Center;border:.2pt solid windowtext;'>AGP Annual Plan - District Level Targets</td>");
                ...
                if (Convert.ToInt32(ddlTpye.SelectedValue) == 2)
                {
                    ...
                    HttpContext.Current.Response.Write("<tr>");
                    HttpContext.Current.Response.Write("<td colspan='27'  style='text-align:Center;border:.2pt solid windowtext;'>AGP Annual Plan - Village Level Targets</td>");
    ...
    public void LoadAnnualDataDeatils2021(int Flag)
    {
        ...
        if (Convert.ToInt32(ddlTpye.SelectedValue) == 1)
        {
            if (ddlYear.SelectedIndex > 0)
            {
                conditions += "    where mst2DistrictAgp.Fyear = '" + ddlYear.SelectedItem.Text + "' ";

            }
            if (ddlStatecode.Length > 0)
            {
                conditions += " and mst2DistrictAgp.StateCode in(" + ddlStatecode + ") ";

            }
            if (ddlDistrict.Length > 0)
            {
                conditions += " and mst2DistrictAgp.DistrictCode in(" + ddlDistrict + ") ";
        ...
        DataTable dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[LoadAnnaulPlanRowDataNew2022Agp]", cmdParameters);
        // DataTable dt = objMain.LoadAnnaulPlanRowData(conditions, Flag);
    ...
    public void LoadAnnualDataSummaryNew2021(int Flag)
    {
        ...
        conditions += "  and mst5VillageAgp.Fyear='" + ddlYear.SelectedItem.Text + "' ";
        cond += "  mst2DistrictAgp.Fyear='" + ddlYear.SelectedItem.Text + "' ";
        if (ddlDistrict.Length > 0)
        {
            conditions += " and mst5VillageAgp.DistrictCode in(" + ddlDistrict + ") ";
            cond += " and mst2DistrictAgp.DistrictCode in(" + ddlDistrict + ") ";
        ...
        DataTable dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptAnnualSummaryReport2021Agp]", cmdParameters);
