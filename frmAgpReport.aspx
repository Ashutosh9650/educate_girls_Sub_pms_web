<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmAgpReport.aspx.cs" Inherits="frmAgpReport" %>
    ...
    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">AGP Detailed Report
                                        </h3>
                                    </div>
                                </div>
        ...
        <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-12 text-left" style="padding-right: 5px; margin-top: 10px;">
            <div style="overflow: auto; margin-top: 0px; height: 590px;">
                <div class="thumbnail" style="overflow: auto; margin-bottom: 0px; height: 568px;">
                    ...
                    <ul style="margin: 0px">
                        ...
                        <li class="li-width">
                            <asp:LinkButton ID="LnkMasterDate" Visible="true" runat="server" Text="AGP Location Master"
