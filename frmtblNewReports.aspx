<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    Culture="en-GB" CodeFile="frmtblNewReports.aspx.cs" Inherits="frmtblNewReports" %>
                    ...
                    <div class="panel-heading" style="padding: 5px 0px;">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div2" class="col-lg-11 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Employee Tracking 
                                        </h3>
                                    </div>
                                </div>
                                <div id="Div3" class="col-lg-1 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="form-group" style="margin-bottom: 10px;">
                                        <asp:LinkButton ID="LinkButton1" runat="server" Visible="false" Text="Export to Excel" OnClick="btnImport_Click"
            ...
            Reports
              ...
              <%--  </div>--%>
                <ul class="nav navbar-nav" style="margin: 0px">
                    ...
                    <li class=" active li-width" runat="server" id="kkk">
                        <asp:LinkButton ID="LinkButton3" runat="server" Text="AdminEmployee Tracking " Style="color: white;"
                            OnClick="btnSerach3_Click"></asp:LinkButton>
                    </li>

                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton2" runat="server" Text="FC Support Report " Style="color: white;"
                            OnClick="btnSerach1_Click"></asp:LinkButton>
                    </li>
                </ul>
            </div>
        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 padd">
                                                        <asp:DropDownList ID="ddlType"  runat="server" OnSelectedIndexChanged="ddlType_SelectedIndexChanged"
                                                            ...
                                                            <asp:ListItem Value="2">Other User </asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-3 cpl-xs-12">
                                                <div class="form-group">
                                                    <label for="email" class="col-sm-3 padd linhei" style="padding-top: 2px;">
                                                        Block:</label>
                                                    <div class="col-sm-7 padd CheckBoxListCssClass" style="border: 1px solid #c1c1c1">
                                                        <div style="overflow: auto; margin-top: 2px; height: 50px;">
                                        ...
                                        <div class="row" runat="server" visible="false">
                                            <div class="col-lg-4 col-md-4 col-sm-4 cpl-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 padd">
                                                        <asp:DropDownList ID="ddlLearningCamp" runat="server" class="form-control ">
                                                            <asp:ListItem Selected="True" Value="0">--Select--</asp:ListItem>
                                                            <asp:ListItem Value="1"> Learning Camp </asp:ListItem>
                                                        ...
                                                        <div class="Row" style="width: 100%">
                                                            <asp:GridView ID="gvD2d" runat="server" OnPageIndexChanging="gvD2d_PageIndexChanging"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <%-- <asp:TemplateField HeaderText="Employee DistrictName" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblDistddddDddate" class="labelGrid" ForeColor="Black" runat="server" Text='<%# Eval("EmployeeDistrictName") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    --%>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="User District" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblDist2rictName" class="labelGrid" ForeColor="Black" runat="server"
                                                                                Text='<%# Eval("UserDist") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="User Block" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblBlock4Name" class="labelGrid" ForeColor="Black" runat="server" Text='<%# Eval("UserBlock") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>

                                                                    <asp:TemplateField HeaderText="ClusterName" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblBlocdk4Name" class="labelGrid" ForeColor="Black" runat="server" Text='<%# Eval("ClusterName") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                            ...
                                                            <asp:GridView ID="gvd2dBo" runat="server" OnPageIndexChanging="gvD2dBo_PageIndexChanging"
                                                                AllowPaging="true" PageSize="100" OnRowDataBound="GridView1Bo_RowDataBound" AutoGenerateColumns="False"
                                                                Font-Names="Arial" Font-Size="12px" Width="100%">
                                                                <EmptyDataTemplate>
                                                                    <div style="font-family: Arial; font-size: 12px; font-weight: bold;">
                                                                        Data not found
