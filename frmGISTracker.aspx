<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="frmGISTracker.aspx.cs" Inherits="frmGISTracker" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                ...
                <div class="thumbnail" style="height: 565PX;">
                    <ul style="margin: 0px">
                        <li class=" active li-width">
                            <asp:LinkButton ID="Button3" runat="server"  Visible="false" OnClick="LnkCHild_OnClick" Style="color: gren;
                                color: blue;" Text="School Summaries "></asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="LinkButton2" runat="server"  Visible="false" OnClick="LnkChildSummary_OnClick"
                        ...
                        <li>
                            <asp:LinkButton ID="LinkButton4"   Visible="false" runat="server" onmouseover="SetText1(this, '');"
                        ...
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton3" runat="server"  Visible="false" OnClick="LnkDeatild_OnClick" Style="color: gren;
                                color: blue;" Text="Enrolment Details "></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton11" runat="server"  Visible="false" OnClick="LnkDeatild1_OnClick" Style="color: gren;
                                color: blue;" Text="Enrolment Fuzzy Matching"></asp:LinkButton>
                        </li>

                         <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton5" runat="server"  Visible="false" OnClick="LnkFillingSystem_OnClick" Style="color: gren;
                                color: blue;" Text="Filing System Details "></asp:LinkButton>
                        </li>
                         <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton6" runat="server"  Visible="false" OnClick="LnkEX_OnClick" Style="color: gren;
                                color: blue;" Text="Exception Report"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton7" Visible="false" runat="server" OnClick="Lnkpf_OnClick" Style="color: gren;
                                color: blue;" Text="Enrolment Summary"></asp:LinkButton>
                        </li>
                          <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton8" runat="server" Visible="false" OnClick="Lnkpfkj_OnClick" Style="color: gren;
                                color: blue;" Text="Enrolment Quality Alert"></asp:LinkButton>
                        </li>
                          <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton9" runat="server"  Visible="false" OnClick="Lnkpfkj33_OnClick" Style="color: gren;
                                color: blue;" Text="Cluster Performance "></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton10" runat="server"  OnClick="Lnkpfkj334_OnClick" Style="color: gren;
                                color: blue;" Text="GIS Heat Map Summary"></asp:LinkButton>
                        </li>

                         <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton12" runat="server"  OnClick="LnkpfkjTest_OnClick" Style="color: gren;
                                color: blue;" Text="GIS Coverage Map Summary"></asp:LinkButton>
                        </li>
                         <%-- <li class=" active li-width">
    ...
    <asp:Panel CssClass="model-wid mod-posi" Style="display: none; width: 76% !important;
        margin-top: 93px !important;" ID="PnlDistrict" runat="server">
