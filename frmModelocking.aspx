<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmModelocking.aspx.cs" Culture="en-GB" MasterPageFile="~/Site.master" Inherits="frmModelocking" %>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <h3 class="text-danger" style="margin: 0px;">
                                            <asp:Label ID="lblMain" runat="server" Text="Manage Module locking "></asp:Label>
                                        </h3>
                                    </div>
                                        ...
                                        <div style="height: 390px; overflow: auto; width: 100%;" align="center">
                                            <asp:GridView ID="GVCluster" runat="server" CssClass="table table-striped table-bordered table-hover"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Lock Date" Visible="true">
                                                        <ItemTemplate>

                                                            <asp:TextBox runat="server" ID="txtDob" autocomplete="off" ondrop="return false;" class="form-control" onkeypress="return false;"></asp:TextBox>

                                                            <ajax:CalendarExtender ID="CalendarExtenderTourdate" runat="server" Enabled="True"
                                                                Format="dd/MM/yyyy" TargetControlID="txtDob" PopupPosition="BottomRight">
                                                            </ajax:CalendarExtender>
                                                            <asp:TextBox ID="txtaddate" Visible="false" ForeColor="Black" runat="server" Text='<%# Eval("LockDate") %>'></asp:TextBox>
