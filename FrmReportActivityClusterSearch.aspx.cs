...
public partial class FrmReportActivityClusterSearch : System.Web.UI.Page
{
    ...
    protected void btnBack_Click(object sender, EventArgs e)
    {
        ...
        {
            Session["Back"] = "1";
            base.Response.Redirect("~/FrmActivityClusterSearchNew.aspx");


        }
        if (Session["user_level"].ToString() == "39")
        {
            Response.Redirect("~/FrmActivityClusterSearchNew.aspx?ID=" + Session["BlockCode"].ToString() + "," + Session["FromData"].ToString() + "," + Session["Todate"] .ToString()+ " ");
    ...
    public void LoadSerarchSchoolActivity()
    {
       ...
       // DGV_Report.Visible = false;
        ...
        con = " ActivityDate between('" + afromDate + "') and '" + aToDate + "'   and UserEntry=3 and mst5village.BlockCode='" + ddlBlock.SelectedValue + "' ";
        dtMain = objMain.LoadSchoolActivtiyCluseterReport(afromDate, aToDate, ddlBlock.SelectedValue, con);
    ...
    public void LoadSearchVillageActivity()
    {
        ...
        con = "   ActivityDate between('" + Session["rfdate"].ToString() + "') and '" + Session["rTodate"].ToString() + "'   and mst5village.BlockCode='" + ddlBlock.SelectedValue + "' ";
        dtMain = objMain.LoadVillageActivtiyClusterWiseNewReport(Session["rfdate"].ToString(), Session["rTodate"].ToString(), ddlBlock.SelectedValue, con);
    ...
    public void LoadSearchOfficeActivtiy()
    {
        ...
        con = "  ActivityDate between('" + Session["rfdate"].ToString() + "') and '" + Session["rTodate"].ToString() + "'   and ApproveStatus in('I','B')  and mst5village.BlockCode='" + ddlBlock.SelectedValue + "' ";
        dtMain = objMain.LoadActivtiyOfficeClusterWiseReport(Session["rfdate"].ToString(), Session["rTodate"].ToString(), ddlBlock.SelectedValue, con);
    ...
    protected void LnkSchool_OnClick(object sender, EventArgs e)
    {
        ...
        else if (UniqueCode == "Learning Midline")
        {
            con1 = "  and    CTL_Midtest>0 ";
        }
        else if (UniqueCode == "Learning Endline")
        {
        ...
        string afromDate = Session["rfdate"].ToString();

        string aToDate = Session["rTodate"].ToString();
        ...
        if (Session["user_level"].ToString() == "19")
        {
            con = " where ActivityDate between('" + afromDate + "') and '" + aToDate + "' and UserEntry=2 and mst5village.BlockCode='" + Session["NewBlockCode"].ToString() + "' ";
            dtMain = objMain.GetSchoolActivtiy(con + con1);

        }
        if (Session["user_level"].ToString() == "39")
        {
            con = "where ActivityDate between('" + afromDate + "') and '" + aToDate + "' and UserEntry=3 and mst5village.BlockCode='" + ddlBlock.SelectedValue + "' ";
            dtMain = objMain.GetSchoolActivtiy(con + con1);
            // dtMain = objMain.LoadSchoolActivtiyCluseterIO(afromDate, aToDate, ddlBlock.SelectedValue, con);
        }
    ...
    protected void LnkOffice_OnClick(object sender, EventArgs e)
    {
        ...
        if (Session["user_level"].ToString() == "39")
        {
            con = "where ActivityDate between('" + afromDate + "') and '" + aToDate + "' and mst5village.BlockCode='" + ddlBlock.SelectedValue + "' ";
