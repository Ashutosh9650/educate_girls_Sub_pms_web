<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmAnnualReportNew.aspx.cs" Inherits="frmAnnualReportNew" %>
                ...
                <div class="thumbnail" style="height: 565PX;">
                    ...
                    <ul  style="margin: 0px">
                        <li class=" active li-width">
                            <asp:LinkButton ID="Button3" runat="server" OnClick="LnkAnnualPlan_OnClick" style="color: gren;color: blue;" Text="Annual Plan Target Sheet "
                               ></asp:LinkButton>
                        </li>
