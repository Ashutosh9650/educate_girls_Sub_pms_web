<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmEnrollmentFormAGP.aspx.cs" Culture="en-GB" Inherits="frmEnrollmentFormAGP" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#LinkButton1').click(function () {
                $('.overleys').addClass('overlay_active');
            })
        });
    </script>
    <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        function isNumberKeyHef(txt, evt) {
            debugger;
            var charCode = (evt.which) ? evt.which : evt.keyCode;
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="thumbnail" style="background-color: #f5f5f5; margin-bottom: 3px !important;">
                            <div class="panel-heading" style="padding: 0px;">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <h3 class="text-danger" style="margin: 0px;">Enrollment AGP</h3>
                    ...
                    <div class="thumbnail" style="background-color: #f5f5f5; float: left; width: 100%;">
                        <div class="panel panel-default" style="margin-bottom: 0px">
                            <div class="form-horizontal">
                                <div class="row">
                                    <div>
                                        <div class="row marg search-bg" style="margin-left: 10px; margin-right: 10px;">
                                            <div class="form-horizontal" style="padding: 10px 0px 0px 10px;">
	...
	<ContentTemplate>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2 col-md-2 col-sm-2 cpl-xs-10 " style="padding: 0px;">
                                                        <asp:ImageButton ID="btnSerach" ToolTip="Serach" Style="margin-left: 10px;" runat="server" OnClick="btnSerach_Click"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 cpl-xs-12" runat="server" id="IDDise" visible="false">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8 padd">
                                                            <asp:TextBox ID="txtDiseCode" onkeypress="return isNumberKey(this,event);"
                                                        ...
                                                        <div class="form-horizontal">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                                                <div style="height: 290px; overflow: auto; width: 100%;" align="center">
                                                                    <div>
                                                                        <div class="Row" style="width: 100%; padding: 5px 10px 10px 10px;">
                                                                            <asp:GridView ID="gvnroll" runat="server" CssClass="table table-striped table-bordered table-hover" DataKeyNames="UniqueChildCode" OnRowDataBound="gvnroll_OnRowCommand" AutoGenerateColumns="False" Font-Names="Arial"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Enrolment Category">
                                                                                        <ItemTemplate>
                ...
                <div style="width: 100%; height: auto; background-color: #f1f1f1">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-horizontal">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="Name" style="padding: 0px">Child Mapping Status <span class="req">*</span></label>

                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlMapping" runat="server" class="form-control" OnSelectedIndexChanged="ddlMapping_SelectedIndexChanged"
                                                AutoPostBack="true">

                                                <asp:ListItem Selected="True" Value="0">--Select--</asp:ListItem>
                                                <asp:ListItem Value="1">D2D </asp:ListItem>
                                                <asp:ListItem Value="2">CIOOSG </asp:ListItem>
                                                <asp:ListItem Value="3">OOD2D</asp:ListItem>

                                            </asp:DropDownList>

                                            <asp:LinkButton ID="LinkButton1" Visible="false" OnClick="ddlMappingNew_SelectedIndexChanged" runat="server">Mapping</asp:LinkButton>
                                        </div>
                                        <label class="control-label col-sm-2" for="Name" id="LblDtdt" style="padding: 0px" runat="server">D2D Unique ID<span class="req">*</span></label>
                                        <div class="col-sm-3">
                                            <asp:TextBox ID="txtUiniqCOde" MaxLength="25" Enabled="false" onkeypress="return isNumberKeyHef(this,event);" class="form-control" autocomplete="off" ondrop="return false;" ForeColor="Black" runat="server"></asp:TextBox>
                                ...
                                <div class="row" runat="server" id="inMapping" visible="false">
                                    <div class="form-group">
                                    </div>
                                </div>
                                <div id="a" runat="server" class="row">
                                    <div class="form-group">
                                        ...
                                        <label class="control-label col-sm-1" style="padding: 0px" for="Name">HH No</label>

                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtHHNo" onpaste="return false" class="form-control" onkeypress="return onlyAlphabetsHH(event,this);" MaxLength="11" onchange="checkPwd(this.value);" autocomplete="off" ondrop="return false;" ForeColor="Black" runat="server"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="txtChildName" class="form-control" onpaste="return false" onkeypress="return onlyAlphabets(event,this);" MaxLength="35" autocomplete="off" ondrop="return false;" ForeColor="Black" runat="server"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <asp:TextBox ID="txtFatherName" onpaste="return false" class="form-control" onkeypress="return onlyAlphabets(event,this);" MaxLength="35" autocomplete="off" ondrop="return false;" ForeColor="Black" runat="server"></asp:TextBox>
                                ...
                                <div class="row" id="Div4" runat="server">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <asp:DropDownList ID="dllClass" class="form-control" runat="server" OnSelectedIndexChanged="ddlClass_SelectedIndexChanged"
                                                AutoPostBack="true">
                                            </asp:DropDownList>
                                ...
                                <div class="row" id="Div5" runat="server">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="txtSrno" onpaste="return false" class="form-control" ForeColor="Black" runat="server" MaxLength="15" onchange="checkPwd(this.value);" autocomplete="off" ondrop="return false;"></asp:TextBox>
                                ...
                                <div id="Div6" runat="server" class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <asp:TextBox runat="server" ID="txtBirth" onpaste="return false" Width="73%" autocomplete="off" ondrop="return false;" class="form-control" onkeypress="return false;"></asp:TextBox>
                                ...
                                <div id="Divkj2" runat="server" class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <asp:TextBox runat="server" ID="txtDobDate" onpaste="return false" Width="73%" autocomplete="off" ondrop="return false;" class="form-control" onkeypress="return false;"></asp:TextBox>
                                ...
                                <div class="row" runat="server">
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="Name" id="Label7" runat="server">Enrolment Category<span class="req">*</span></label>

                                        <div class="col-sm-6">
                                            <asp:DropDownList ID="ddlEduationStatus" OnSelectedIndexChanged="ddlClass_SelectedIndexChanged"
                                    ...
                                    <div class="row" id="Div12" runat="server" visible="false">
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="Name" id="Label12" runat="server">Enrolment Attempt </label>

                                            <div class="col-sm-6">

                                                <asp:DropDownList ID="ddlNew" CssClass="form-control" runat="server">
                                                    <asp:ListItem Selected="True" Value="0">--Select--</asp:ListItem>
                                                    <asp:ListItem Value="1">1-New (Fresher) </asp:ListItem>
                                                    <asp:ListItem Value="2"> 2-Old (Repeater)</asp:ListItem>
                                                </asp:DropDownList>
                                    ...
                                    <div id="GroupA" class="row" runat="server" visible="false">
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="Name" id="Label9" runat="server">Group A Subject <span class="req">*</span></label>
                                    ...
                                    <div id="GroupB" class="row" runat="server">
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="Name" id="Label11" runat="server">Group B Subject <span class="req">*</span></label>
                                    ...
                                    <div class="row" id="Div9" runat="server">
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="Name" id="Label10" runat="server">Samagra ID<span class="req">*</span></label>
                                    ...
                                    <div class="row" id="Div10" runat="server">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <asp:TextBox ID="txtSurveyVillage" onpaste="return false" class="form-control" MaxLength="50" runat="server"></asp:TextBox>
                    ...
                    <div class="modal-footer">
                        <div id="Div11" class="col-lg-12 col-md-12 col-sm-12 cpl-xs-12" runat="server">
                            <asp:ImageButton ID="ImageButton1" OnClientClick="return checkSpace();" Style="margin-top: -18px" ValidationGroup="Valid" class="btn btn-primary pull-pull-right"
            ...
            <cc1:ModalPopupExtender ID="MpexdrDistrict2" runat="server" BackgroundCssClass="modalBg "
                CancelControlID="CancelButton1" PopupControlID="PnlDistrict2" TargetControlID="HdnFild2">
            </cc1:ModalPopupExtender>
            <asp:HiddenField ID="HdnFild2" runat="server"></asp:HiddenField>
            <asp:Panel CssClass="model-wid mod-posi" Style="display: none; background-color: #f5f5db; height: auto; width: 45% !important; margin-top: 17.5px !important;"
                ID="PnlDistrict2" runat="server">
                <div style="width: 100%; height: 590px;">
                    <div class="modal-header" style="background-color: #ddd; color: White;">
                        <h4 class="modal-title" style="forecolor: White; float: left;">D2d Mapping

                        </h4>
                        <div id="Div16" class="" style="float: right;" runat="server">
                            <asp:ImageButton ID="ImageButtddon1" class="" OnClick="btnSaveNew_Click"
                    ...
                    <div class="modal-body">
                        <fieldset class="scheduler-border" runat="server" id="s333tmid">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <asp:DropDownList ID="ddlBlockSearch" OnSelectedIndexChanged="ddlBlockSearch_SelectedIndexChanged" AutoPostBack="true" runat="server"
                                                    class="form-controlNew">
                                                </asp:DropDownList>
                                                <span style="width: 5px; float: right; margin: -27px 27px; font-size: 21px;"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            <label for="email" class="linhei">
                                                Panchayat :</label>
                                            <div class=" ">
                                                <asp:DropDownList ID="ddlphan" OnSelectedIndexChanged="ddlphan_SelectedIndexChanged" AutoPostBack="true" runat="server"
                                                    class="form-control ">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <asp:DropDownList ID="ddlvillageSearch"
                                    ...
                                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                        <asp:ImageButton ID="ImageButton3" ToolTip="Serach" Style="margin-left: 10px; margin-top: 28px;" runat="server"
                                            class="btn btn-danger btn-paddd pull-left" OnClick="btnSerachNew_Click" BackColor="#f1f1f1" ImageUrl="~/images/search-29.png" />
                                    </div>
                        ...
                        <fieldset class="scheduler-border" runat="server" id="Fieldset1">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div class="form-group" style="overflow: auto; margin-top: 2px; height: 341px;">

                                    <asp:GridView ID="GridView2" runat="server" CssClass="table table-bordered table-responsive Grid" AllowSorting="true" PageSize="170"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="" HeaderStyle-Width="35px">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="ChkD2d" runat="server" CssClass="cls"
