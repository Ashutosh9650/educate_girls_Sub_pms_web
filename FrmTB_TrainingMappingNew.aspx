<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="FrmTB_TrainingMappingNew.aspx.cs" Inherits="FrmTB_TrainingMappingNew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="thumbnail" style="background-color: #f5f5f5; margin-bottom: 3px !important;">
                    <div class="panel-heading" style="padding: 0px 0px;">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <h3 class="text-danger" style="margin: 0px;">Training Update Module</h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 5px;">
            <div class="thumbnail" style="background-color: #f5f5f5; float: left; width: 100%; margin-bottom: 0px;">
                    ...
                    <div class="form-horizontal">
                        <div class="row">
                            <div style="padding: 0px 10px;">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-2 col-sm-2 cpl-xs-12">
                                                <div class="form-group">
                                                    <label for="email" class="col-sm-4 padd linhei" style="padding-top: 2px;">
                                                        District:</label>
                                                    <div class="col-sm-8 padd">
                                                        <asp:DropDownList ID="ddlDistrict" AutoPostBack="true" OnSelectedIndexChanged="ddlDist_SelectedIndexChanged" runat="server" class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 cpl-xs-12">
                                                ...
                                                <asp:LinkButton ID="LinkButton1" runat="server" Text="Export to Excel" OnClick="btnExportExcel_Click"></asp:LinkButton>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <ContentTemplate>
                                                <div class="form-horizontal">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                                        <div style="height: 295px; overflow: auto; width: 100%;" align="center">
                                                            <div>
                                                                <div class="Row" style="width: 100%">
                                                                    <asp:GridView ID="gvnroll" runat="server" CssClass="table table-striped table-bordered table-hover"
                                                                        OnRowDataBound="gvnroll_OnRowDataBound" AutoGenerateColumns="False"
                                                                            ...
                                                                            <asp:TemplateField HeaderText="No of Day">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="TxtN_P1_Y1" MaxLength="3" CssClass="form-control" ForeColor="Black"
                                                                                        Width="96%" runat="server" onkeypress="return isNumberKey(this,event);" Text='<%# Eval("N_P1_Y1") %>'></asp:TextBox>
                                                                                </ItemTemplate>
                                ...
                                <asp:Panel CssClass="model-wid" Style="display: none; height: auto; width: 45% !important; margin-top: -112px !important; top: 452px !important;"
                                    ...
                                    <div style="width: 100%; height: auto; background-color: #f1f1f1">
                                        <div class="modal-header" style="background-color: #ddd; color: Black;">
                                            <h4 class="modal-title" style="forecolor: Black">Training Outcome</h4>
                                        </div>
