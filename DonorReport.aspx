<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="DonorReport.aspx.cs" Inherits="DonorReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Donor Report
                                        </h3>
                                    </div>
                                </div>
        ...
        <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-12 text-left" style="padding-right: 0px; margin-top: 10px">
            <div style="overflow: auto; margin-top: 0px; height: 820px;">
                    ...
                    <ul style="margin: 0px">
                        ...
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LnkDeatild_OnClick" Style="color: gren; color: blue;"
                                Text="Donor Report "></asp:LinkButton>
                        </li>
                                                ...
                                                <ContentTemplate>
                                                    <div class="row">
                                                        <div class="col-sm-2 ">
                                                               ...
                                                               Year</label>
                                                              <asp:DropDownList ID="ddlStartYear" OnSelectedIndexChanged="ddlStartYear_SelectedIndexChanged"    AutoPostBack="true" runat="server" class="form-control">
                                                            ...
                                                            <label for="email" class="padd linhei" style="padding-top: 2px;">
                                                                Donor Name</label>
                                                            <asp:DropDownList ID="ddlDonor" runat="server" OnSelectedIndexChanged="ddlYear_SelectedIndexChanged"
                                                                AutoPostBack="true" class="form-control ">
                                                            </asp:DropDownList>
                                                            <label for="email" class="padd linhei" style="padding-top: 2px;">
                                                                Geography</label>
                                                            <asp:DropDownList ID="ddInGeography" Enabled="false" runat="server" class="form-control">
                                                                <asp:ListItem Selected="True" Value="0">--Select--</asp:ListItem>
                                                        ...
                                                        <div class="col-sm-2 " style="margin-bottom: 15px">
                                                            ...
                                                            <div class="padd CheckBoxListCssClass " style="border: 1px solid #c1c1c1">
                                                                <div style="overflow: auto; margin-top: 1px; height: 100px;">
                                                                    <asp:CheckBoxList ID="ChkState" Enabled="false" RepeatDirection="Vertical" OnSelectedIndexChanged="ddlState_SelectedIndexChanged"
                                                        ...
                                                        <div class="col-sm-2 ">
                                                            ...
                                                            <div class="CheckBoxListCssClass" style="border: 1px solid #c1c1c1">
                                                                <div style="overflow: auto; margin-top: 1px; height: 100px;">
                                                                    <asp:CheckBoxList Enabled="false" ID="chkDistrict" RepeatDirection="Vertical" OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged"
                                                                        AutoPostBack="true" runat="server">
                                                                    </asp:CheckBoxList>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-2 ">
                                                            <label for="email" class="padd linhei" style="padding-top: 2px;">
                                                                Block</label>
                                                            <div class="CheckBoxListCssClass" enabled="false" style="border: 1px solid #c1c1c1">
                                                        ...
                                                        <div class="col-sm-2 ">
                                                            ...
                                                            <div style="border: 1px solid #c1c1c1">
                                                                <div style="overflow: auto; margin-top: 1px; height: 30px;">
                                                            ...
                                                            <asp:DropDownList ID="ddlYear" Visible="false" runat="server" class="form-control ">
                                                            </asp:DropDownList>

                                                        </div>
                                                        <div id="Div1" class="col-sm-2 " runat="server">
                                                            <label for="email" class="padd linhei" style="padding-top: 2px;">
                                                                Start Month and Year : 
                                                            </label>
                                                            <div style="border: 1px solid #c1c1c1">
                                                                <div style="overflow: auto; margin-top: 1px; height: 24px;">
                                                                    <asp:Label runat="server" ForeColor="Black" ID="lblTarget"></asp:Label>
                                                                    <asp:Label runat="server" Visible="false" ForeColor="Black" ID="lblState"></asp:Label>
                                                                    <asp:Label runat="server" Visible="false" ForeColor="Black" ID="lblDistrict"></asp:Label>
                                                                    <asp:Label runat="server" Visible="false" ForeColor="Black" ID="lblBlock"></asp:Label>
                                                                    <asp:Label runat="server" Visible="false" ForeColor="Black" ID="lblGType"></asp:Label>
                                                                    <asp:Label runat="server" Visible="false" ForeColor="Black" ID="lblFrequency"></asp:Label>
                                                                    <asp:Label runat="server" Visible="false" ForeColor="Black" ID="lblPri"></asp:Label>
                                                                    <asp:Label runat="server" Visible="false" ForeColor="Black" ID="lblState1"></asp:Label>
                                                                    <asp:Label runat="server" Visible="false" ForeColor="Black" ID="lblDistrict1"></asp:Label>
                                                                    <asp:Label runat="server" Visible="false" ForeColor="Black" ID="lblBlock1"></asp:Label>

                                                                    <asp:Label runat="server" Visible="false" ForeColor="Black" ID="lblFyear"></asp:Label>
                                                                    <asp:Label runat="server" Visible="false" ForeColor="Black" ID="lblMonth"></asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="row" style="width: 100%">
                                                        <asp:GridView ID="GV_DynamicGrid" AutoGenerateColumns="False" runat="server" OnPageIndexChanging="GV_DynamicGrid1_OnPageIndexChanging"
                                                            ForeColor="Black" AllowPaging="true" PageSize="200" ShowHeader="true" Visible="false"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="Reporting Outcome">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblChildName" runat="server" Text='<%# Eval("OutcomeName") %>'></asp:Label>

                                                                    </ItemTemplate>
                                                                    <ItemStyle CssClass="padding-center" />

                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Reporting Indicator">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Target">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblFathfame" runat="server" Text='<%# Eval("Target") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle CssClass="padding-lef" />

                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="Target-YTD">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblFathfame" runat="server" Text='<%# Eval("TargetYTD") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle CssClass="padding-lef" />
                                                                 ...
                                                                 <asp:TemplateField HeaderText="ACH">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblAACHMonthH" runat="server" Text='<%# Eval("ACHMonth") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle CssClass="padding-lef" />

                                                                </asp:TemplateField>
                                                                   <asp:TemplateField HeaderText="Reportable Achv" Visible="true">
                                                                                        <ItemTemplate>
                                                                                            <asp:Label ID="txtReportableAchv"  runat="server"
                                                                                                Text='<%# Eval("ReportableAchv") %>'></asp:Label>
                                                                                        </ItemTemplate>
                                                                                        <ItemStyle CssClass="padding-lef" />
                                                                ...
                                                                <asp:TemplateField HeaderText="ACH">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblACH" runat="server" Text='<%# Eval("ACH") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle CssClass="padding-lef" />

                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="ACH-YTD">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblYTD" runat="server" Text='<%# Eval("YTD") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle CssClass="padding-lef" />
                                                        ...
                                                        <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" OnPageIndexChanging="GV_DynamicGrid1_OnPageIndexChanging"
                                                            ForeColor="Black" AllowPaging="true" PageSize="200" ShowHeader="true" Visible="false"
                                                            CssClass="table table-striped table-bordered table-hover" Width="100%">
                                                            <EmptyDataTemplate>
                                                            </EmptyDataTemplate>
