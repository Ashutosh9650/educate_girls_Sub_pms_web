<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="frmAssmentReport.aspx.cs" Inherits="frmAssmentReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Assessment Report
                                        </h3>
                                    </div>
                                </div>
        ...
        <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-12 text-left" style="padding-right: 0px; margin-top: 10px">
            <div style="overflow: auto; margin-top: 0px; height: 800px;">
                <div class="thumbnail" style="height: 748PX;">
                    <ul style="margin: 0px">
                        ...
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LnkDeatild_OnClick" Style="color: gren; color: blue;"
                                Text="Summary Report"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LnkFillingSystem_OnClick" Style="color: gren; color: blue;"
                                Text="Response Raw Data"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LnkEX_OnClick" Style="color: gren; color: blue;"
                                Text="Emp Response Score"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton7" runat="server" OnClick="Lnkpf_OnClick" Style="color: gren; color: blue;"
                                Text="Question Wise Analysis"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkDeatild1_OnClick" Style="color: gren; color: blue;"
                                Text="Survey Link Report"></asp:LinkButton>
                        </li>

                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LnkDeatild1_OnClickAll" Style="color: gren; color: blue;"
                                Text="Team Balika Assessment"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton8" runat="server" OnClick="LnkDeatild1_OnClickAll2" Style="color: gren; color: blue;"
                                Text="Compile/Overall Staff Assessment "></asp:LinkButton>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="form-horizontal">
                        <div class="row">
                            ...
                            <div id="div-show" style="display: block; float: right; width: calc(100% - 20px); margin: 0px 10px; position: relative; top: -8px;">
                                <div class="row marg search-bg" style="margin-top: 17px;">
                                    <div class="form-horizontal">
                                        <div class="row">
                                                ...
                                                <ContentTemplate>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3 ">
                                                            ...
                                                            <asp:DropDownList ID="ddlLevel" OnSelectedIndexChanged="ddlLevel_SelectedIndexChanged"
                                                                AutoPostBack="true" runat="server" class="form-control">
                                                            </asp:DropDownList>
                                                            <asp:Label runat="server" ID="d1" for="email" class="padd linhei" Style="padding-top: 2px;">
                                                                Training outCome </asp:Label>
                                                            <asp:DropDownList ID="ddlLearning" AutoPostBack="true" OnSelectedIndexChanged="ddlLearning_SelectedIndexChanged" runat="server" class="form-control ">
                                                            </asp:DropDownList>
                                                            <label for="email" runat="server" id="d2" class="padd linhei" style="padding-top: 5px;">
                                                                Specific Training :</label>
                                                            <asp:DropDownList ID="ddlTraingOutcome" AutoPostBack="true" OnSelectedIndexChanged="ddlTraingOutcome_SelectedIndexChanged" runat="server" class="form-control">
                                                            </asp:DropDownList>
                                                        </div>
                                                        <div class="col-sm-3 ">
                                                            <label for="email" class="padd linhei" style="padding-top: 2px;">
                                                                Assessment Name :</label>
                                                            <asp:DropDownList ID="ddlForm"
                                                                AutoPostBack="true" runat="server" class="form-control">
                                                            </asp:DropDownList>
                                                            <%-- <label for="email" class="padd linhei"  style="padding-top: 2px;">
                                                                Batch ID</label>
                                                            <asp:DropDownList ID="DropDownList2" style="margin-top: -8px;" runat="server" class="form-control ">
                                                            </asp:DropDownList>--%>
                                                            <label for="email" class="padd linhei" style="padding-top: 5px;">
                                                                Assessment Type :</label>
                                                            <asp:DropDownList ID="ddlAssessmentType" Style="margin-top: -8px;" runat="server" class="form-control">
                                                                <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                                                                <asp:ListItem Text="Baseline " Value="1"></asp:ListItem>
                                                                <asp:ListItem Text="Endline Level" Value="2"></asp:ListItem>
                            ...
                            <div class="col-lg-12 table table-hover " style="padding: 0px 10px 1px 10px;">
