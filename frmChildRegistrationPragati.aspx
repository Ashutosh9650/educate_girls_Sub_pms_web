<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmChildRegistrationPragati.aspx.cs" Inherits="frmChildRegistrationPragati" %>
    ...
    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Pragati CBL Report
                                        </h3>
                                    </div>
                                </div>
        ...
        <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-12 text-left" style="padding-right: 5px; margin-top: 10px;">
            <div style="overflow: auto; margin-top: 0px; height: 586px;">
                <div class="thumbnail" style="height: 566PX; margin-bottom: 0px;">

                    <ul style="margin: 0px">
                        <%--  <li ><asp:Label ID="ddsd" Text="--------CBL--------" runat="server"  Font-Size="Medium" style="color:Black;font:size:larger;" ></asp:Label></li>--%>
                        <li class=" active li-width">
                            <asp:LinkButton ID="Button3" runat="server" OnClick="LnkAnnualPlan_OnClick" Style="color: gren; color: blue;" Text="Child Registration"></asp:LinkButton>
                        </li>

                        <li>
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkAnnualPlanFC_OnClick" Style="color: gren; color: blue;" Text="Child Attendance"></asp:LinkButton>
                        </li>

                        <%--  
                      <li >
                            <asp:LinkButton ID="LinkButton4" runat="server"  OnClick="LnkAnnualPl_OnClick" style="color: gren;color: blue;" Text="Attendance Summary "
                               ></asp:LinkButton>
                        </li>
                          <li >
                            <asp:LinkButton ID="LinkButton5" runat="server"  OnClick="LnkAnnualPlGrad_OnClick"   style="color: gren;color: blue;" Text="CBL Learning Grade Report"
                               ></asp:LinkButton>
                        </li>

                        <li >
                            <asp:LinkButton ID="LinkButton3" runat="server"  OnClick="LnkAVisitors" style="color: gren;color: blue;" Text="Visitors Report "
                               ></asp:LinkButton>
                        </li>
                        <li >
                            <asp:LinkButton ID="LinkButton6" runat="server" Visible="false"  OnClick="LnkVillageLevel" style="color: gren;color: blue;" Text="CBL Progress Tracking Report"
                               ></asp:LinkButton>
                        </li>
                           <li runat="server" visible="false" >
                            <asp:LinkButton ID="LinkButton7" runat="server" Visible="false"  OnClick="LnkCPLLevel" style="color: gren;color: blue;" Text="CBL Quality Alert Report"
                               ></asp:LinkButton>
                        </li>--%>

                        <%--  <li >
                            <asp:LinkButton ID="LinkButton8" runat="server"  OnClick="LnkCPLLevel21" style="color: gren;color: blue;" Text="CBL Quality Alert Report"
                               ></asp:LinkButton>
                        </li>--%>


                        <%--                                               <li ><asp:Label ID="Label1" Text="--------SBL--------" runat="server"  Font-Size="Medium" style="color:Black;font:size:larger;" ></asp:Label></li>
                        <li>
                            <asp:LinkButton ID="LinkButton9" runat="server"   OnClick="LnkSBLChild" style="color: gren;color: blue;" Text="SBL Child Registration"
                               ></asp:LinkButton>
                        </li>
                          
                           <li >
                            <asp:LinkButton ID="LinkButton10" runat="server"  OnClick="LnkSBLAtten" style="color: gren;color: blue;" Text="SBL Child Attendance"
                               ></asp:LinkButton>
                        </li>
                         <li >
                            <asp:LinkButton ID="LinkButton11" runat="server"  OnClick="LnkAVisitorsSbL" style="color: gren;color: blue;" Text="SBL Visitors Report "
                               ></asp:LinkButton>
                        </li>--%>
                    </ul>
                </div>
                ...
                <div class="panel panel-default" style="margin-bottom: 0px">
                    <div class="form-horizontal">
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2 ">
                                                ...
                                                <asp:DropDownList ID="ddlGroup" runat="server" Visible="false" class="form-control">
                                                    ...
                                                    <asp:ListItem Value="01">Camp-01</asp:ListItem>
                                                    <asp:ListItem Value="02">Camp-02</asp:ListItem>
                                                    <asp:ListItem Value="03">Camp-03</asp:ListItem>
                                                    <asp:ListItem Value="04">Camp-04</asp:ListItem>
                                                ...
                                                <asp:DropDownList ID="ddlLevel" Visible="false" runat="server" class="form-control">
                                                    <asp:ListItem Selected="True" Value="0">--Select--</asp:ListItem>
                                                    <asp:ListItem Value="1">District Wise </asp:ListItem>
                                                    <asp:ListItem Value="2">Village Wise </asp:ListItem>
                                                    <asp:ListItem Value="4">Cluster Wise </asp:ListItem>
                            ...
                            <div class="col-lg-12 table table-hover " style="padding: 5px 10px;">
