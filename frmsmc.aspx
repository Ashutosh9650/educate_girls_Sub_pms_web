<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmsmc.aspx.cs" Inherits="frmsmc" %>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Community Level SMC Meeting
                                        </h3>
                                    </div>
                                </div>
                ...
                <div class="thumbnail" style="height: 580PX;">
                    ...
                    <ul style="margin: 0px">
                        <li class=" active li-width">
                            <asp:LinkButton ID="Button3" runat="server" OnClick="LnkAnnualPlan_OnClick" Style="color: gren; color: blue;" Text="Community Level SMC Meeting "></asp:LinkButton>
                        </li>
                ...
                <div class="panel panel-default" style="margin-bottom: 0px">
                    <div class="form-horizontal">
                        <div class="row">
                            ...
                            <div class="col-lg-12 table table-hover " style="padding: 4px 10px 0px 10px;">
