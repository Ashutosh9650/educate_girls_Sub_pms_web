<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="FrmDistictProfile.aspx.cs" Inherits="FrmDistictProfile" %>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="thumbnail" style="background-color: #f5f5f5;margin-bottom: 0px !important;">
                    <div class="panel-heading" style="padding: 0px;">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <h3 class="text-danger" style="margin: 0px;">Distict Profile Report <span class="pull-right" style="font-size: 17px; margin-top: 5px;">
           ...
           <%-- <div class="li-width" style="min-height: 110px;">
            ...
            <ul class="nav navbar-nav" style="margin: 0px">
                <li class=" active li-width">
                    <asp:LinkButton ID="Button3" runat="server" Text="Distict Profile Report " Style="color: white;"
                        OnClick="PMS_Click"></asp:LinkButton>
                </li>
                <li class=" active li-width">
                    <asp:LinkButton ID="LinkButton1" Visible="false" runat="server" Text="Learning Baseline Analysis " Style="color: white;"
                        OnClick="PMSBaseline_Click"></asp:LinkButton>
                </li>
                <li class="li-width">
                    <asp:LinkButton ID="ff" runat="server" Visible="false" Text="Learning Baseline" Style="color: white;"></asp:LinkButton></li>
                <li class="li-width">
                    <asp:LinkButton ID="LinkButton2" Visible="false" runat="server" Text="Learning Baseline Grouping" Style="color: white;"></asp:LinkButton></li>
                                            ...
                                            <div style="height: 290px; overflow: auto; width: 99%;" align="center">
                                                <div>
                                                    <div id="Div1" class="Row" style="width: 100%" runat="server">
                                                        ...
                                                        <asp:GridView ID="DGV_Report" AllowPaging="true" PageSize="30" runat="server" ForeColor="#333333" CellPadding="1" CssClass="table table-striped table table-hover table-bordered  " AutoGenerateColumns="true" Width="99.7%">
