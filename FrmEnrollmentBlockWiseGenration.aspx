<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="FrmEnrollmentBlockWiseGenration.aspx.cs" Culture="en-GB" Inherits="FrmEnrollmentBlockWiseGenration" %>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 cpl-xs-12">
                                        <div class="form-group" style="margin-bottom: 7px;">
                                            ...
                                            <div class="col-sm-9 padd">
                                                <asp:DropDownList ID="ddlBlock" Visible="false" AutoPostBack="true" OnSelectedIndexChanged="ddlBlock_OnSelectedIndexChanged" runat="server" class="form-control ">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="panel panel-default" id="pnlMain" runat="server">
                                <div class="panel-heading" style="padding: 0px 0px 0px 15px;">
                                    <h3 class="text-danger" style="margin: 0px 0px 15px 0px;">
                                        <span style="position: relative; top: 7px;">Seal-Sign Generation </span>
                                        <asp:Button ID="btnBack" CssClass="btn btn-success pull-right btn-sm " ToolTip="Save" Text="Back"
                                            OnClick="btnBack_Click" Style="margin-top: 5px; margin-right: 15px;"
                                            runat="server" />
                                    </h3>
                                </div>
                                <div id="ColMain">
                                    <div class="panel-body panel-body-new" style="padding: 15px 0px 0px;">
                                                            ...
                                                            <asp:TemplateField ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <div id="div<%# Eval("BlockCode") %>" style="display: none;">
                                                                        <asp:GridView ID="GridView2" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="false" DataKeyNames="ClusterCode"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField ItemStyle-Width="150px" DataField="ChildrenSealSign" HeaderText="Pending Seal-sign generation" />
