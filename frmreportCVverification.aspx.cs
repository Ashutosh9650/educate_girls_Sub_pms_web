...
public partial class frmreportCVverification : System.Web.UI.Page
{
        ...
        protected void Page_Load(object sender, EventArgs e)
    {
        ...
        public void FillUser()
        {
            ...
            conditions = "";
            objComman.BindDLL("mstForm", "FormID,FormName ", conditions, "FormID", "asc", ddlUser, "FormName", "FormID", "--Select--");
        ...
        public void LoadReport()
        {
            ...
            if (ddlPhan.Length > 0)
            {
                conditions += " and PanchayatCode in(" + ddlPhan + ") ";
            }
            if (ddlVillage.Length > 0)
            {
            ...
            try
            {
               ...
               // DataTable dt = objMain.ReportCVverifivcation(FristCon, FormID);

      
        SqlParameter[] p = new SqlParameter[]
        {
            new SqlParameter("@Str", FristCon),
            new SqlParameter("@Form", FormID)
        };
         DataTable dt =SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "sp_VerficationReport", p);
        ...
        protected void btnExcel_click(object sender, EventArgs e)
        {
            ...
            if (ddlUser.SelectedIndex > 0)
            {
                ename = Convert.ToString(ddlUser.SelectedItem);
            }
            if(dtreport.Rows.Count>0)
            {
