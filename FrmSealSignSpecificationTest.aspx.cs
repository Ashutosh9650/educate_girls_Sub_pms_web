...
public partial class FrmSealSignSpecificationTest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Convert.ToString(Session["user_level"]) == "39" || Convert.ToString(Session["user_level"]) == "30")
            {
...
new SqlParameter("@condtion", Frist)
    ...
    public void LoadReport()
    {
        ...
        DataTable dt2 = EnrollmentRightGrid_20200613(FristCon);
