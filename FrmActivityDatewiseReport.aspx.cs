...
public partial class FrmActivityDatewiseReport : System.Web.UI.Page
{
    ...
    public void LoadSerarchSchoolActivity()
    {
        ...
        con = " ActivityDate between('" + afromDate + "') and '" + aToDate + "'  and ApproveStatus in('B','I')  and mstCluster.ClusterCode='" + Session["Cluseter"].ToString() + "' ";
        dtMain = objMain.LoadAllActivtiyDateWiseAll(afromDate, aToDate, Session["Cluseter"].ToString(), con, 1);
        string condation = "";
        condation = "ActivityDate between('" + afromDate + "') and '" + aToDate + "'  and mstCluster.ClusterCode='" + Session["Cluseter"].ToString() + "' ";



        DataTable dtApprove = objMain.LoadActivtiyApproveAllReport(condation, 1);
    ...
    public void LoadVIllageProfile()
    {
        ...
        con = "   ActivityDate between('" + Session["rfdate"].ToString() + "') and '" + Session["rTodate"].ToString() + "'   and mstCluster.ClusterCode='" + Session["Cluseter"].ToString() + "' ";
        dtMain = objMain.LoadAllActivtiyDateWiseAll(Session["rfdate"].ToString(), Session["rTodate"].ToString(), Session["Cluseter"].ToString(), con, 2);
        string condation = "";
        condation = "ActivityDate between('" + Session["rfdate"].ToString() + "') and '" + Session["rTodate"].ToString() + "'  and  UserEntry ='3' and mstCluster.ClusterCode='" + Session["Cluseter"].ToString() + "' ";



        DataTable dtApprove = objMain.LoadActivtiyApproveAllReport(condation, 2);
        ...
        if (dtMain.Rows.Count > 0)
        {
            ...
            for (int Index = 1; Index < gvVillageActivity.HeaderRow.Cells.Count - 1; Index++)
            {
                ...
                //firstCell.Controls.Add(new HyperLink { NavigateUrl = "./frmMobileVillageProfile.aspx?ID=" + firstCell.Text + "," + Session["Cluseter"].ToString() + "," + txtDate.Text + "", Text = firstCell.Text });

                gvVillageActivity.HeaderRow.Cells[0].Visible = false;
            }
            for (int Index = 0; Index < gvVillageActivity.Rows.Count; Index++)
            {
                gvVillageActivity.Rows[Index].Cells[0].Visible = false;
            }
    ...
    public void LoadSearchOfficeActivtiy()
    {
        ...
        con = "   ActivityDate between('" + Session["rfdate"].ToString() + "') and '" + Session["rTodate"].ToString() + "' and ApproveStatus in('B','I')   and mstCluster.ClusterCode='" + Session["Cluseter"].ToString() + "' ";
        dtMain = objMain.LoadAllActivtiyDateWiseAll(Session["rfdate"].ToString(), Session["rTodate"].ToString(), Session["Cluseter"].ToString(), con, 3);

        condation = "ActivityDate between('" + Session["rfdate"].ToString() + "') and '" + Session["rTodate"].ToString() + "'  and mstCluster.ClusterCode='" + Session["Cluseter"].ToString() + "' ";



        DataTable dtApprove = objMain.LoadActivtiyApproveAllReport(condation, 3);
        int count = 0;
        lblOffice.Visible = false;
        if (dtMain.Rows.Count > 0)
        {
            ...
            for (int Index = 1; Index < gvOffice.HeaderRow.Cells.Count - 1; Index++)
            {
                ...
                if (drApp.Length > 0)
                {
                    if (drApp[0]["ApproveStatus"].ToString() == "B")
                    {
                        gvOffice.HeaderRow.Cells[Index].BackColor = Color.Orange;
                    }
                    if (drApp[0]["ApproveStatus"].ToString() == "I")
                    {
                        gvOffice.HeaderRow.Cells[Index].BackColor = Color.Green;
                    }
                }
                #endregion
                firstCell.Controls.Clear();
                ...
                gvOffice.HeaderRow.Cells[0].Visible = false;
            }
            for (int Index = 0; Index < gvOffice.Rows.Count; Index++)
            {
                gvOffice.Rows[Index].Cells[0].Visible = false;
            }
