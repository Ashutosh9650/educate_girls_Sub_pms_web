...
public partial class frmChildRegistrationAgp : System.Web.UI.Page
{
    ...
    protected void LnkAnnualPlanFCNew_OnClick(object sender, EventArgs e)
    {
        ViewState["1"] = 10;

        getActivitySIPTargetvsAchvNew(1);
    ...
    protected void LnkAnnualPl_OnClickNew(object sender, EventArgs e)
    {
        ViewState["1"] = 15;

        getActivitySIPTargetvsSummaryNew(1);
    ...
    protected void btnImport_Click(object sender, EventArgs e)
    {
        if (ViewState["1"].ToString() == "9" && Convert.ToString(ViewState["SAC"]) != "")
        {
            ...
            ExportToCSVFile(st, "ChildRegistrationAgp");
           
        }
        if (ViewState["1"].ToString() == "10" && Convert.ToString(ViewState["SAC"]) != "")
        {
            DataTable st = ViewState["SAC"] as DataTable;
            ExportToCSVFile(st, "ChildAttendanceAgp");
        ...
        {
            DataTable st = ViewState["SAC"] as DataTable;
            ExportToCSVFile(st, "ChildAttendanceSummaryAgp");


        }
        if (ViewState["1"].ToString() == "11" && Convert.ToString(ViewState["SAC"]) != "")
        {
            DataTable st = ViewState["SAC"] as DataTable;
    ...
    public void getSACUpdateReport(Int32 Flag)
    {
        ...
        dtMain = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptChildRegistrationAgp]", cmdParameters);
        ...
        if (dtMain.Rows.Count > 0)
        {
            ...
            {
                ExportToCSVFile(dtMain, "ChildRegistrationAgp");
            }
            else
            {
    ...
    public void getActivitySIPTargetvsSummary(Int32 Flag)
    {
        ...
        if (ddlGroup.SelectedIndex > 0)
        {
            ...
            conditions1 = conditions1 + " and  tblChildAttendanceAgp.CampID='" + ddlGroup.SelectedValue + "' ";
        }
        ...
        dtMain = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptAttendentSummaryAgp]", cmdParameters);
        ViewState["SAC"] = dtMain;
        if (dtMain.Rows.Count > 0)
        {
            //DataTable newDataTable = dtMain.Clone();
            ...
            if (dtMain.Rows.Count > 0)
            {
                ...
                {
                    ExportToCSVFile(dtMain, "ChildAttendanceSummary");
                }
                else
                {
                    GV_DynamicGrid.Visible = true;
    ...
    public void getActivitySIPTargetvsSummaryNew(Int32 Flag)
    {
        ...
        dtMain = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptAttendentSummaryAgpNew]", cmdParameters);
        ViewState["SAC"] = dtMain;
        if (dtMain.Rows.Count > 0)
        {
            //DataTable newDataTable = dtMain.Clone();
    ...
    public void getActivitySIPTargetvsAchv(Int32 Flag)
    {
        ...
        dtMain = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptChildAttendenceAgp]", cmdParameters);
        ViewState["SAC"] = dtMain;
        if (dtMain.Rows.Count > 0)
        {
            //DataTable newDataTable = dtMain.Clone();
    ...
    public void getActivitySIPTargetvsAchvNew(Int32 Flag)
    {
        ...
        dtMain = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptChildAttendenceAgpNew]", cmdParameters);
        ViewState["SAC"] = dtMain;
        if (dtMain.Rows.Count > 0)
        {
            //DataTable newDataTable = dtMain.Clone();
    ...
    public void getActivityVisitors(Int32 Flag)
    {
        ...
        dtMain = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptVisitorsAgp]", cmdParameters);
        ViewState["SAC"] = dtMain;
        if (dtMain.Rows.Count > 0)
        {
            //DataTable newDataTable = dtMain.Clone();
