<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmUserRights.aspx.cs" Inherits="frmUserRights" %>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <h3 class="text-danger" style="margin: 0px;">
                                    <asp:Label ID="lblMain" runat="server" Text="Manage User Rights"></asp:Label>
                                </h3>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="padding: 0px;">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="text-danger" style="margin: 4px 0px 4px -8px;">User role</h4>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <asp:ImageButton ID="btn_Add" OnClientClick="return CheckAdd();" class="btn btn-info pull-right"
                                        ...
                                        <asp:ImageButton ID="btnDelete" OnClick="btnDelete_Click" class="btn btn-info pull-right"
                                                ...
                                                <asp:GridView ID="GV_UserPermission" runat="server" OnRowCreated="GVUserPermission_RowCreated" CssClass="Grid" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Add">
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="Add_check" runat="server" />
                                                            </ItemTemplate>
                                                            <HeaderStyle BackColor="#C1C1C1" ForeColor="White" HorizontalAlign="Center" />
                                                        ...
                                                        <asp:TemplateField HeaderText="View">
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="Offlineview_check" runat="server" />
                                                            </ItemTemplate>
                                                            <HeaderStyle BackColor="#C1C1C1" ForeColor="White" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Add">
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="OfflineAdd_check" runat="server" />
                                                            </ItemTemplate>
                                                            <HeaderStyle BackColor="#C1C1C1" ForeColor="White" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Edit">
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="Offlineedit_check" runat="server" />
                                                            </ItemTemplate>
                                                            <HeaderStyle BackColor="#C1C1C1" ForeColor="White" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Delete">
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="Offlinedelete_check" runat="server" />
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                                                        </asp:TemplateField>
