<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="frmGKpChildReg.aspx.cs" Inherits="frmGKpChildReg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">GKP Report
                                        </h3>
                                    </div>
                                </div>
    ...
    <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-12 text-left" style="padding-right: 0px; margin-top: 10px">
        <div style="overflow: auto; margin-top: 0px; height: 745px;">
            <div class="thumbnail" style="height: 725PX;">
                <ul style="margin: 0px">
                    <%--         <li class=" active li-width">
                            <asp:LinkButton ID="Button3" runat="server" OnClick="LnkCHild_OnClick" Style="color: gren;
                                color: blue;" Text="School Summaries "></asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkChildSummary_OnClick"
                                Style="color: gren; color: blue;" onmouseover="SetText(this, '');" onmouseout="SetText(this, 'Process Monitoring');"
                                Text="Process monitoring "></asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="LinkButton4" Visible="true" runat="server" onmouseover="SetText1(this, '');"
                                onmouseout="SetText1(this, 'Target monitoring');" Text="Target Monitoring" Style="color: gren;
                                color: blue;" OnClick="LnkChildSummaryTarget_OnClick"></asp:LinkButton></li>--%>
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LnkDeatild_OnClick" Style="color: gren; color: blue;"
                            Text="GKP Child Registration"></asp:LinkButton>
                    </li>
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton7" runat="server" OnClick="LnkDeatild2_OnClick" Style="color: gren; color: blue;"
                            Text="GKP Child Registration Class 2"></asp:LinkButton>
                    </li>
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LnkFillingSystem_OnClick" Style="color: gren; color: blue;"
                            Text="GKP Child Attendance"></asp:LinkButton>
                    </li>

                      <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton15" runat="server" OnClick="LnkFillingSystem111_OnClick" Style="color: gren; color: blue;"
                            Text="GKP Gyanodaya Child Attendance"></asp:LinkButton>
                    </li>

                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LnkEX_OnClick" Style="color: gren; color: blue;"
                            Text="GKP Assessment"></asp:LinkButton>
                    </li>
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton9" runat="server" OnClick="LnkEX55_OnClick" Style="color: gren; color: blue;"
                            Text="GKP Assessment Class 2"></asp:LinkButton>
                    </li>
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkgkSummary_OnClick" Style="color: gren; color: blue;"
                            Text="GKP Summary"></asp:LinkButton>
                    </li>

                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton4" runat="server" OnClick="GKPAssessmentSummary_OnClick" Style="color: gren; color: blue;"
                            Text="GKP Assessment Summary"></asp:LinkButton>
                    </li>


                      <li class=" active li-width">
                            <asp:LinkButton ID="lnjjj" runat="server" OnClick="GKPAsses_OnClick" Style="color: gren;
                                color: blue;" Text="Session Monitoring Report"></asp:LinkButton>
                        </li>

                    <li class=" active li-width" runat="server" visible="false" >
                        <asp:LinkButton ID="LinkButton13" runat="server" OnClick="GKPAsImage_OnClick" Style="color: gren; color: blue;"
                            Text="GKP Image"></asp:LinkButton>
                    </li>

                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton8" runat="server" OnClick="GKPAssessmentAlert1_OnClick" Style="color: gren; color: blue;"
                            Text="GKP Quality Alert"></asp:LinkButton>
                    </li>
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton10" runat="server" OnClick="LnkDeatildGyanodaya_OnClick" Style="color: gren; color: blue;"
                            Text="Gyanodaya Child Registration"></asp:LinkButton>
                    </li>

                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton11" runat="server" OnClick="LnkFillingSystemGyanodaya_OnClick" Style="color: gren; color: blue;"
                            Text="Gyanodaya Child Attendance"></asp:LinkButton>
                    </li>
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton12" runat="server" OnClick="LnkEXGyanodaya_OnClick" Style="color: gren; color: blue;"
                            Text="Gyanodaya Assessment"></asp:LinkButton>
                    </li>
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton14" runat="server" OnClick="LnkGKPAttendanceTracker_OnClick" Style="color: gren; color: blue;"
                            Text="Gyanodaya Summary"></asp:LinkButton>
                    </li>

                     <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton16" runat="server" OnClick="Lnk1_OnClick" Style="color: gren; color: blue;"
                            Text="GKP VidhyaSabha"></asp:LinkButton>
                    </li>
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton17" runat="server" OnClick="Lnk2_OnClick" Style="color: gren; color: blue;"
                            Text="GKP Child Preparation"></asp:LinkButton>
                    </li>
                    <li class=" active li-width">
                        <asp:LinkButton ID="LinkButton18" runat="server" OnClick="Lnk3_OnClick" Style="color: gren; color: blue;"
                            Text="GKP Utsav"></asp:LinkButton>
                    </li>

                          <li>  <asp:LinkButton ID="LinkButton19" Visible="true" runat="server" Text="GKP School Master Update Approval  Report"
                                Style="color: gren; color: blue;" OnClick="AnnalPlanExce1l11_Hotspottest"></asp:LinkButton></li>
                        <li>  <asp:LinkButton ID="LinkButton20" Visible="true" runat="server" Text="BO View Approval  Report"
                                Style="color: gren; color: blue;" OnClick="AnnalPlanExce1l115_Hotspottest"></asp:LinkButton></li>
                      <li class=" active li-width">
