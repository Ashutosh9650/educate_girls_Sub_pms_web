<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="frmD2dSurveyExpansionRaj.aspx.cs" Inherits="frmD2dSurveyExpansionRaj" %>
            ...
            <div style="overflow: auto; margin-top: 0px; height: 747px;">
                <div class="thumbnail" style="overflow: auto; margin-bottom: 0px; height: 726px;">
                    <ul style="margin: 0px">
                        ...
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LnkQuality_OnClick" Text="Quality Alert Report"></asp:LinkButton>
                        </li>
                    </ul>
                </div>
            </div>
