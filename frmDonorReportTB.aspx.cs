...
public partial class frmDonorReportTB : System.Web.UI.Page
{
    ...
    public void LoadUserLeavel()
       ...
       {
        if (Convert.ToInt32(ddlGrouping.SelectedValue) >= 0)
        {
    ...
    protected void btnTBTrainingBalika_Click(object sender, EventArgs e)
    {
        LoadReportTeamBalikWOtk(1);

    }
    public void LoadReportTeamBalikWOtk(Int32 flag)
    {
        ...
        string[] Year1 = Year.Split('-');
            ...
            if (ddlYear.SelectedIndex > 0)
            {
            conditionsNe= "    And XDropoutdate < '" + Year1[0] + "-04-01' ";
    ...
    protected void btnTBPrograss_Click(object sender, EventArgs e)
    {
            ...
            lnkReport.Visible = false;
            ViewState["Donar"] = "";
        LoadReportTeamProcesstraning(1);

       

    }
    protected void btnTBPrograss1_Click(object sender, EventArgs e)
    {
    ...
    protected void btnTBPrograss2_Click(object sender, EventArgs e)
    {
    ...
    protected void btnTBPrograss3_Click(object sender, EventArgs e)
    {

        lnkReport.Visible = false;
        ViewState["Donar"] = "";
        LoadReportTeamTBCalling(2);



    }
    protected void btnTBPrograss4_Click(object sender, EventArgs e)
    {

        lnkReport.Visible = false;
        ViewState["Donar"] = "";
        LoadReportTeamTBCallingAward(2);
            ...
            if (dtTable.Columns.Count != 0)
            {
                ...
                foreach (DataRow row in dtTable.Rows)
                {
                    foreach (DataColumn column in dtTable.Columns)
                    {
                        ...
                        sbldr.Append(Convert.ToString(row[column]).Replace("\r", "").Replace("\n", "") + ',');
                    }
                    sbldr.Append("\r\n");
    ...
    private void ExportToCSVFile(DataTable dtTable, string filePath)
       ...
       public void LoadReportEnrollmentSummaryOpt(Int32 flag)
       {
           ...
           SqlParameter[] cmdParameters = new SqlParameter[]
		{
           ...
           DataTable     dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rpEnrollmentDonorOther]", cmdParameters);
           if (dt.Rows.Count > 0)
           {
       ...
       public void LoadReportEnrollmentSummary(Int32 flag)
       {
           ...
           SqlParameter[] cmdParameters = new SqlParameter[]
		{
           ...
           DataTable dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rpEnrollmentDonor]", cmdParameters);
           if (dt.Rows.Count > 0)
           {
       ...
       public void LoadReportTeamBalikSummary(Int32 flag)
       {
           ...
           SqlParameter[] cmdParameters = new SqlParameter[]
		{
            ...
            new SqlParameter("@Flag", flag),
             new SqlParameter("@Groupby",ddlGrouping.SelectedValue),
               new SqlParameter("@CreatDate",CreatDate),
                new SqlParameter("@CreatDate1",CreatDate1),
            new SqlParameter("@FYear", ddlYear.SelectedItem.Text),
             new SqlParameter("@workinStatus", work),

        };

           DataTable dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptTeamBalikSummary2025]", cmdParameters);
           if (dt.Rows.Count > 0)
           {
       ...
       public void LoadReportTeamBalikSummaryTtraning(Int32 flag)
       {
           ...
           SqlParameter[] cmdParameters = new SqlParameter[]
		  {
           ...
           DataTable dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptTempBalikTrainingNew]", cmdParameters);
           if (dt.Rows.Count > 0)
           {
               dt.Columns.Remove("Totalmonth");
    ...
    public void LoadReportTeamProcesstraning(Int32 flag)
    {
    ...
    public void LoadReportTeamFC(Int32 flag)
    {
        ...
        if (ddlYear.SelectedIndex > 0)
        {
            ...
            if (flag==2)
            {
                conditions += " and   v.Fyear = '" + ddlYear.SelectedItem.Text + "' ";
            }
        }
        if (ddlStatecode.Length > 0)
        {
    ...
    private void GenerateExcelNewBlock2023Alter(DataTable dt)
    {
        try
        {
            ...
            {
                wb = new XLWorkbook(StartupPath + "\\TBPerformance202511.xlsx");
            }else
            {
                wb = new XLWorkbook(StartupPath + "\\TBPerformance202511.xlsx");
            }
            ...
            ws.Cell(6, 1).InsertData(dt.Rows);
            Int32 ii = Convert.ToInt32(dt.Rows.Count) + 6;
            string str = "";
            if (Convert.ToInt32(ddlYear.SelectedValue) >= 2025)
            {
                str = "A2:AZ" + ii;
            ...
            filepath = StartupPath + "\\TBPerformance" + "_" + System.DateTime.Now.ToString("hhssmmfff") + ".xlsx";
            wb.SaveAs(filepath);
       ...
       protected void gvReportNew_RowCreated(object sender, GridViewRowEventArgs e)
       {
           ...
           if (e.Row.RowType == DataControlRowType.Header)
           {
               ...
               if (ViewState["Donar"].ToString() == "5")
               {
                ...
                HeaderCell = new TableCell();
                HeaderCell.Text = "Total Days without TB";
                HeaderCell.HorizontalAlign = HorizontalAlign.Center;
               ...
               if (ViewState["Donar"].ToString() == "6")
               {
                   ...
                   HeaderCell = new TableCell();
                   HeaderCell.Text = "Team Balika LSE Review";
                   HeaderCell.HorizontalAlign = HorizontalAlign.Center;
                   ...
                   HeaderCell = new TableCell();
                   HeaderCell.Text = "TB Training on Community Based Learning";
                   HeaderCell.HorizontalAlign = HorizontalAlign.Center;
                   ...
                   HeaderCell = new TableCell();
                   HeaderCell.Text = "TB Training on Camp Vidya-2";
                   HeaderCell.HorizontalAlign = HorizontalAlign.Center;
       ...
       private void GenerateExcelNew(string FIleName)
       {
           try
           {
               ...
               if (dt.Rows.Count > 0)
               {
                   ...
                   HttpContext.Current.Response.Write("<table  >");
                   HttpContext.Current.Response.Write("<tr>");
                   HttpContext.Current.Response.Write("<td colspan='13' ' style='text-align:Center;border:.2pt solid windowtext;'>Enrollment Donor </td>");
       ...
       private void GenerateExcelTeamBalik(string FIleName)
       {
           try
           {
               ...
               if (dt.Rows.Count > 0)
               {
                ...
                if (Convert.ToInt32(ddlGrouping.SelectedValue) == 0)
                {
                    HttpContext.Current.Response.Write("<td colspan='14' ' style='text-align:Center;border:.2pt solid windowtext;'>TB Recruitment Report </td>");

                    HttpContext.Current.Response.Write("</tr>");
                    HttpContext.Current.Response.Write("<td colspan='14' ' style='text-align:Left;border:.2pt solid windowtext;'>Date :" + DateTime.Now + " </td>");
                }
                if (Convert.ToInt32(ddlGrouping.SelectedValue) == 1)
                {
                ...
                if (Convert.ToInt32(ddlGrouping.SelectedValue) == 2)
                {
                    HttpContext.Current.Response.Write("<td colspan='17' ' style='text-align:Center;border:.2pt solid windowtext;'>TB Recruitment Report </td>");
                ...
                if (Convert.ToInt32(ddlGrouping.SelectedValue) == 3)
                {
                    HttpContext.Current.Response.Write("<td colspan='18' ' style='text-align:Center;border:.2pt solid windowtext;'>TB Recruitment Report </td>");

                    HttpContext.Current.Response.Write("</tr>");
                    HttpContext.Current.Response.Write("<td colspan='18' ' style='text-align:Left;border:.2pt solid windowtext;'>Date :" + DateTime.Now + " </td>");
                }

                if (Convert.ToInt32(ddlGrouping.SelectedValue) == 4)
                {
                    HttpContext.Current.Response.Write("<td colspan='21' ' style='text-align:Center;border:.2pt solid windowtext;'>TB Recruitment Report </td>");

                    HttpContext.Current.Response.Write("</tr>");
                    HttpContext.Current.Response.Write("<td colspan='21' ' style='text-align:Left;border:.2pt solid windowtext;'>Date :" + DateTime.Now + " </td>");
                }
                HttpContext.Current.Response.Write("</tr>");
                   String HeaderStyle = "border:.3pt solid windowtext; font-weight:700;   word-wrap: normal; word-break: break-all; ";
                   HttpContext.Current.Response.Write("<tr style='font-width:bold;'>");
                ...
                if (Convert.ToInt32(ddlGrouping.SelectedValue) == 0)
                {
                    ...
                    HttpContext.Current.Response.Write("<th class='header' colspan='3' style='" + HeaderStyle + "  width:2%;'>Current Year Drop Out</th>");
                ...
                if (Convert.ToInt32(ddlGrouping.SelectedValue) == 1)
                   ...
                   if (Convert.ToInt32(ddlGrouping.SelectedValue) == 4)
                   {
                       HttpContext.Current.Response.Write("<th class='header' colspan='9'  rowspan='1' style='" + HeaderStyle + "  width:2%;'> </th>");
                       HttpContext.Current.Response.Write("<th class='header' colspan='1' style='" + HeaderStyle + "  width:2%;'>Target</th>");
                       HttpContext.Current.Response.Write("<th class='header' colspan='3' style='" + HeaderStyle + "  width:2%;'>Current Year Drop Out</th>");
                       HttpContext.Current.Response.Write("<th class='header' colspan='3' style='" + HeaderStyle + "  width:2%;'>Working </th>");
                       HttpContext.Current.Response.Write("<th class='header' colspan='3' style='" + HeaderStyle + "  width:2%;'>TB Newly Joined </th>");
                ...
                if (Convert.ToInt32(ddlGrouping.SelectedValue) == 0)
                {
                    ...
                    HttpContext.Current.Response.Write("<th class='header'  style='" + HeaderStyle + "  width:2%;'>Total Days without TB</th>");
                ...
                if (Convert.ToInt32(ddlGrouping.SelectedValue) == 1)
                   ...
                   if (Convert.ToInt32(ddlGrouping.SelectedValue) == 4)
                   {
                    ...
                    HttpContext.Current.Response.Write("<th class='header' style='" + HeaderStyle + "  width:2%;'> State Name</th>");
                    HttpContext.Current.Response.Write("<th class='header' style='" + HeaderStyle + "  width:2%;'> District Name</th>");
                    HttpContext.Current.Response.Write("<th class='header' style='" + HeaderStyle + "  width:2%;'> Admin District Name</th>");
                    HttpContext.Current.Response.Write("<th class='header' style='" + HeaderStyle + "  width:2%;'> EG Block Name</th>");
                       HttpContext.Current.Response.Write("<th class='header' style='" + HeaderStyle + "  width:2%;'> Admin Block Name</th>");
                       HttpContext.Current.Response.Write("<th class='header' style='" + HeaderStyle + "  width:2%;'> Cluster Name</th>");
                       HttpContext.Current.Response.Write("<th class='header' style='" + HeaderStyle + "  width:2%;'> Village Code</th>");
                       HttpContext.Current.Response.Write("<th class='header' style='" + HeaderStyle + "  width:2%;'> Village Name</th>");
                       HttpContext.Current.Response.Write("<th class='header' style='" + HeaderStyle + "  width:2%;'> Operational Status</th>");
                    HttpContext.Current.Response.Write("<th class='header' style='" + HeaderStyle + "  width:2%;'> Target</th>");
                       HttpContext.Current.Response.Write("<th class='header'  style='" + HeaderStyle + "  width:2%;'> Female</th>");
                       HttpContext.Current.Response.Write("<th class='header' style='" + HeaderStyle + "  width:2%;'> Male</th>");
                       HttpContext.Current.Response.Write("<th class='header'  style='" + HeaderStyle + "  width:2%;'> Drop Out Total</th>");
                   ...
                   for (int J = 0; J < 1; J++)
                   {
                    ...
                    if (Convert.ToInt32(ddlGrouping.SelectedValue) == 1)
                       ...
                       if (Convert.ToInt32(ddlGrouping.SelectedValue) == 4)
                       {
                           for (int c = 0; c < dt.Columns.Count; c++)
                           {
                               if (c == 0 || c == 2 || c == 1 || c == 3 || c == 4 || c == 5 || c == 6 || c == 7 || c == 8)
                               {
                                   if (c == 8)
                                   {
                                       HttpContext.Current.Response.Write("<td style='" + RowStyle + "'>" + "TOTAL" + "</td>");
       ...
       private void GenerateExcelTeamBalikTraning(string FIleName)
       {
           try
           {
               ...
               if (dt.Rows.Count > 0)
               {
                   ...
                   HttpContext.Current.Response.Write("<table  >");
                   HttpContext.Current.Response.Write("<tr>");
                   HttpContext.Current.Response.Write("<td colspan='30' ' style='text-align:Center;border:.2pt solid windowtext;'>TB Training Report </td>");

                   HttpContext.Current.Response.Write("</tr>");
                   HttpContext.Current.Response.Write("<td colspan='30' ' style='text-align:Left;border:.2pt solid windowtext;'>Date :" + DateTime.Now + " </td>");
                   ...
                   HttpContext.Current.Response.Write("<th class='header' colspan='2' style='" + HeaderStyle + " mso-rotate: 90; width:2%;'>	Team Balika LSE Review 	</th>");
                   HttpContext.Current.Response.Write("<th class='header' colspan='2' style='" + HeaderStyle + " mso-rotate: 90; width:2%;'>	TB Training on Community Based Learning 	</th>");
                   HttpContext.Current.Response.Write("<th class='header' colspan='2' style='" + HeaderStyle + " mso-rotate: 90; width:2%;'>	TB Training on Camp Vidya-2 	</th>");
                   HttpContext.Current.Response.Write("<th class='header' colspan='2' style='" + HeaderStyle + " mso-rotate: 90; width:2%;'>	CPP 	</th>");
                   HttpContext.Current.Response.Write("<th class='header' colspan='2' style='" + HeaderStyle + " mso-rotate: 90; width:2%;'>	POSH 	</th>");
