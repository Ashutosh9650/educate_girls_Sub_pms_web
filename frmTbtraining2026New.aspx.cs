...
public partial class frmTbtraining2026New : System.Web.UI.Page
{
    ...
    public void FillScheduling()
    {
        ...
        if (Convert.ToString(Session["username"]) == "PMSAdmin" || Convert.ToString(Session["username"]) == "EGE7557" || Convert.ToString(Session["username"]) == "SuperAdmin")
        {
            objComman.BindDLL("[tblStaffScheduling] left join mstlearning on mstlearning.learningID=[Outcome]", "[ScheduleID] ,mstlearning.learningName +' ( '+ convert (varchar(10),[FromDate] ,121)  +' To '+ convert (varchar(10),[ToDate] ,121) +' )' as Schedule ", "   Flag=1 and SdeleteFlag=1 and TrainingTypeFlag =2 and  FromDate>'2026-04-01' ", "Schedule", "asc", ddlSchedue, "Schedule", "ScheduleID", "--Select--");
        ...
        else
        {
            ...
            objComman.BindDLL("[tblStaffScheduling] left join mstlearning on mstlearning.learningID=[Outcome]", "[ScheduleID] ,mstlearning.learningName +' ( '+ convert (varchar(10),[FromDate] ,121)  +' To '+ convert (varchar(10),[ToDate] ,121) +' )' as Schedule ", " userID like '%" + Session["username"] + "%' and  Flag=1 and SdeleteFlag=1 and TrainingTypeFlag =2 and LockRecord=1 and  FromDate>'2026-04-01' ", "Schedule", "asc", ddlSchedue, "Schedule", "ScheduleID", "--Select--");
    ...
    {
        DataTable dtEntryDoneBY = new DataTable(); dtEntryDoneBY.Columns.Add(new DataColumn("ParticiparticipateName", System.Type.GetType("System.String")));
