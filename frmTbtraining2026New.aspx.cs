...
public partial class frmTbtraining2026New : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Convert.ToString(Session["username"]) != "")
            {
                ...
                Session["dtAttendation2026TB"] = null;
    ...
    public void AlllStateCode()
        ...
        private void GVMainBind()
        {
            ...
            string textnew = "where mstSpineDistrict.StateCode='" + this.ddlState.SelectedValue.ToString() + "'  and tblStaffScheduling.Flag=2 and TrainingTypeFlag=2";
            string text = "where mst2District.StateCode='" + this.ddlState.SelectedValue.ToString() + "' and TrainingTypeFlag=2 and mst2District.Fyear='" + ddlYear.SelectedItem.Text + "'  and tblStaffScheduling.Flag=2 ";
    ...
    //    if (Convert.ToString(Session["username"]) == "PMSAdmin" || Convert.ToString(Session["username"]) == "EGE7557" || Convert.ToString(Session["username"]) == "SuperAdmin")
    //    {
    //        objComman.BindDLL("[tblStaffScheduling] left join mstlearning on mstlearning.learningID=[Outcome]", "[ScheduleID] ,convert(varchar, ScheduleID)+'-'+ mstlearning.learningName +' ( '+ convert (varchar(10),[FromDate] ,121)  +' To '+ convert (varchar(10),[ToDate] ,121) +' )' as Schedule ", "   Flag=1 and SdeleteFlag=1 and TrainingTypeFlag =2 and  FromDate>'2026-04-01' ", "Schedule", "asc", ddlSchedue, "Schedule", "ScheduleID", "--Select--");

    //    }
    //    else
    //    {
    //        objComman.BindDLL("[tblStaffScheduling] left join mstlearning on mstlearning.learningID=[Outcome]", "[ScheduleID] ,convert(varchar, ScheduleID)+'-'+ mstlearning.learningName +' ( '+ convert (varchar(10),[FromDate] ,121)  +' To '+ convert (varchar(10),[ToDate] ,121) +' )' as Schedule ", " userID like '%" + Session["username"] + "%' and  Flag=1 and SdeleteFlag=1 and TrainingTypeFlag =2 and LockRecord=1 and  FromDate>'2026-04-01' ", "Schedule", "asc", ddlSchedue, "Schedule", "ScheduleID", "--Select--");
    //    }
        ...
        else
        {
            ...
            if (Session["user_level_Role"].ToString() == "2")
            {
                ...
                if (DistrictName.Length > 0)
                {
                  ...
                  objComman.BindDLL("[tblStaffScheduling] left join mstlearning on mstlearning.learningID=[Outcome]", "[ScheduleID] ,convert(varchar, ScheduleID)+'-'+ mstlearning.learningName +' ( '+ convert (varchar(10),[FromDate] ,121)  +' To '+ convert (varchar(10),[ToDate] ,121) +' )' as Schedule ", "  DistrictCode in(" + DistrictName + ") and  Flag=1 and SdeleteFlag=1 and TrainingTypeFlag =2 and LockRecord=1 and  FromDate>'2026-04-01' ", "Schedule", "asc", ddlSchedue, "Schedule", "ScheduleID", "--Select--");
            ...
            else if (Convert.ToString(Session["user_level"]) == "138")
            {
                ...
                objComman.BindDLL("[tblStaffScheduling] left join mstlearning on mstlearning.learningID=[Outcome]", "[ScheduleID] ,convert(varchar, ScheduleID)+'-'+ mstlearning.learningName +' ( '+ convert (varchar(10),[FromDate] ,121)  +' To '+ convert (varchar(10),[ToDate] ,121) +' )' as Schedule ", "  " + conditions + " and  Flag=1 and SdeleteFlag=1 and TrainingTypeFlag =2 and LockRecord=1 and  FromDate>'2026-04-01' ", "Schedule", "asc", ddlSchedue, "Schedule", "ScheduleID", "--Select--");
    ...
    private void ExporttoExcel(DataTable table)
        ...
        private void Save_Update(int SchoolCode)
        {
            ...
            if (ViewState["Save"].ToString() == "Save")
            {
                ...
                if (Session["dtAttendation2026TB"] != null)
                {
                    DataTable dtatt = Session["dtAttendation2026TB"] as DataTable;
        ...
        protected void gvTb_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //if (lblTday1.Text == "P")
            //{
            //    Chk_final1.SelectedValue = lblTday1.Text;
            //}
            //if (lblTday2.Text == "P")
            //{
            //    Chk_final2.Checked = true;
        ...
        private void FillControls(string ptCOde)
        {
            ...
            //if (Session["user_level"].ToString() == "60" && Days <= 90)
            //{
            //    btnsave.Enabled = true;
            //    btnDelete.Enabled = true;

            //}
            //else if ((Session["user_level"].ToString() == "25" || Session["user_level"].ToString() == "61" || Session["user_level"].ToString() == "101") && Days <= 15)
            //{
            //    btnsave.Enabled = true;
            //    btnDelete.Enabled = true;
            //}
            ...
            else if ((Session["user_level"].ToString() == "25" || Session["user_level"].ToString() == "61" || Session["user_level"].ToString() == "101") && Days <= 90)
            {
                btnsave.Enabled = true;
                btnDelete.Enabled = true;
            }
        ...
        DataTable DateSearch=Session["DateSearch"] as DataTable;
            dt = ((DataTable)Session["dtSPTB"]);
            if (Session["dtAttendation2026TB"] != null)
            {
                dtParticiparticipate = ((DataTable)Session["dtAttendation2026TB"]);
                iFlag = 1;
            }
            else
            {
                    ...
                    if (word.Length > 3)
                    {
                        ...
                        if (drmain.Length > 0)
                            ...
                            else
                            {
                                ...
                                dtP1 = Get_DataFor1Filter1("LoadStaffParticiparticipate", "2", word.Trim());
        ...
        Session["dtSPTB"] = dt;
            UpdateGridBlank();
            Session["dtAttendation2026TB"] = dtParticiparticipate;
