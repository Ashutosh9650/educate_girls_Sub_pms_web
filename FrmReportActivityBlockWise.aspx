<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="FrmReportActivityBlockWise.aspx.cs"  Culture="en-GB" Inherits="FrmReportActivityBlockWise" %>
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="School Activity" Visible="true">
                                                                                <ItemTemplate>
                                                                                                                   ...
                                                                                                                   <asp:Label ID="lblUn1" ForeColor="Black"  Text='<%# Bind("School") %>' Font-Names="Calibri" ItemStyle-ForeColor="#333"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Village Activity" Visible="true">
                                                                                <ItemTemplate>
                                                                                 ...
                                                                                 <asp:Label ID="lblvllV_2" Text='<%# Bind("Village") %>'  ForeColor="Black" Font-Names="Calibri" ItemStyle-ForeColor="#333"
                                                                                        runat="server" ></asp:Label>
                                                                ...
                                                                <AlternatingRowStyle BackColor="#f1f1f1" />
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Office Activity " Visible="true">
                                                                                <ItemTemplate>
                                                                                     <asp:Label ID="lbooff"  Text='<%# Bind("Village") %>'   ForeColor="Black" Font-Names="Calibri" ItemStyle-ForeColor="#333"
                                                                                        runat="server" ></asp:Label>
                                                                                </ItemTemplate>
