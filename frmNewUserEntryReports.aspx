<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" Culture="en-GB" CodeFile="frmNewUserEntryReports.aspx.cs" Inherits="frmNewUserEntryReports" %>
                                        ...
                                        <div class="row">
                                         <div class="col-lg-3 col-md-3 col-sm-3 cpl-xs-12">
                                          ...
                                          <div id="Div1" class="col-lg-3 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                            ...
                                            <div id="Div14" class="col-lg-3 col-md-3 col-sm-3 cpl-xs-12" runat="server">
                                                <div class="form-group">
                                                    <label for="email" class="col-sm-3 padd linhei" style="padding-top: 2px;">
                                                        Village:</label>
                                                    <div class="col-sm-8 padd CheckBoxListCssClass" style="border:1px solid #c1c1c1">
