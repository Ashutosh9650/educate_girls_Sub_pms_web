<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmDonorReportTB.aspx.cs" Inherits="frmDonorReportTB" %>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div2" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Team Balika Report
                                        </h3>
                                    </div>
                                </div>
                 ...
                 <%--   </div>--%>
                    <ul class="nav navbar-nav" style="margin: 0px">
                        ...
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton2" runat="server" Visible="false" OnClick="btnEnrolllmenSummary_Click" Text="Enrolment Donor "
                        ...
                        <li class="li-width">
                            <asp:LinkButton ID="LinkButton9" Visible="false" runat="server" OnClick="btnEnrolllmenSummaryOps_Click" Text="Enrolment Against Target"
                        ...
                        <li class="li-width">
                            <asp:LinkButton ID="LinkButton8" Visible="true" runat="server" OnClick="btnTB_Click" Text="TB Recruitment Report"
                                Style="color: white;"></asp:LinkButton></li>


                        <li class="li-width">
                            <asp:LinkButton ID="LinkButton15" Visible="true" runat="server" OnClick="btnTBTrainingBalika_Click" Text="Team Balika Profile"
                                Style="color: white;"></asp:LinkButton></li>


                        <li class="li-width">
                            <asp:LinkButton ID="LinkButton4" Visible="true" runat="server" OnClick="btnTBTraining_Click" Text="TB Training Report"
                                Style="color: white;"></asp:LinkButton></li>
                        <li class="li-width">
                            <asp:LinkButton ID="LinkButton7" Visible="false" runat="server" OnClick="btnTBPrograss_Click" Text="TB Progress Report"
                                Style="color: white;"></asp:LinkButton></li>
                        <li class="li-width">
                            <asp:LinkButton ID="LinkButton10" runat="server" OnClick="btnTBPrograss1_Click" Text="FC-TB CLuster Meeting"
                                Style="color: white;"></asp:LinkButton></li>

                        <li class="li-width">
                            <asp:LinkButton ID="LinkButton11" runat="server" OnClick="btnTBPrograss2_Click" Text="FC-TB Cluster Meeting Attendance"
                                Style="color: white;"></asp:LinkButton></li>

                        <li class="li-width">
                            <asp:LinkButton ID="LinkButton13" runat="server" OnClick="btnTBPrograss3_Click" Text=" Team Balika Calling"
                                Style="color: white;"></asp:LinkButton></li>
                        <li class="li-width">
                            <asp:LinkButton ID="LinkButton14" runat="server" OnClick="btnTBPrograss4_Click" Text=" Team Balika Award"
                                Style="color: white;"></asp:LinkButton></li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="row marg search-bg">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 cpl-xs-12" style="padding: 0px;">
                                                <div class="form-group">
                                                    <label for="email" class="col-sm-3 padd linhei" style="padding-top: 2px; padding-left: 12px;">
                                                        Year:</label>
                                                    <div class="col-sm-8 padd" style="padding: 0px 0px 0px 20px;">
                                                ...
                                                <div class="form-group">
                                                    <label for="email" class="col-sm-3 padd linhei" style="padding-top: 2px; padding-left: 30px;">
                                                        Grouping:
                                                    </label>
                                                    <div class="col-sm-8 padd" style="padding: 0px 0px 0px 20px;">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 cpl-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9 padd" style="padding: 0px 8px 0px 12px;">
                                                        <asp:DropDownList ID="ddlWOrkingStatus" runat="server"
                                                            class="form-control ">
                                                ...
                                                <%-- <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 padd CheckBoxListCssClass" style="border:1px solid #c1c1c1">
                                                     <div style="overflow: auto; margin-top:2px; height:50px; ">
                                                      <asp:CheckBoxList ID="chkAge" RepeatDirection="Vertical"    runat="server">
                                                        </asp:CheckBoxList>
