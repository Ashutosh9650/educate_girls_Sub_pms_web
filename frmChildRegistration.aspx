<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmChildRegistration.aspx.cs" Inherits="frmChildRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Learning Camp Report
                                        </h3>
                                    </div>
                                </div>
        ...
        <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-12 text-left" style="padding-right: 0px; margin-top: 10px">
            <div style="overflow: auto; margin-top: 0px; height: 610px;">
                <div class="thumbnail" style="height: 590PX;">

                    <ul style="margin: 0px">
                        <li>
                            <asp:Label ID="ddsd" Text="--------CBL--------" runat="server" Font-Size="Medium" Style="color: Black; font: size:larger;"></asp:Label></li>
                        ...
                        <li>
                            <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LnkAnnualPl_OnClick" Style="color: gren; color: blue;" Text="Attendance Summary "></asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LnkAnnualPlGrad_OnClick" Style="color: gren; color: blue;" Text="CBL Learning Grade Report"></asp:LinkButton>
                        </li>

                        <li>
                            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LnkAVisitors" Style="color: gren; color: blue;" Text="Visitors Report "></asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="LinkButton6" runat="server" Visible="false" OnClick="LnkVillageLevel" Style="color: gren; color: blue;" Text="CBL Progress Tracking Report"></asp:LinkButton>
                        </li>
                        <li runat="server" visible="false">
                            <asp:LinkButton ID="LinkButton7" runat="server" Visible="false" OnClick="LnkCPLLevel" Style="color: gren; color: blue;" Text="CBL Quality Alert Report"></asp:LinkButton>
                        </li>

                        <li>
                            <asp:LinkButton ID="LinkButton8" runat="server" OnClick="LnkCPLLevel21" Style="color: gren; color: blue;" Text="CBL Quality Alert Report"></asp:LinkButton>
                        </li>
