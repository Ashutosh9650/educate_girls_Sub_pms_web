<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="frmTrvelMatrixTracker.aspx.cs" Culture="en-GB" Inherits="frmTrvelMatrixTracker" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Travel Matrix Reports
                                        </h3>
                                    </div>
                                </div>
                    ...
                    <ul style="margin: 0px">
                        ...
                        <li>
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkChildSummary_OnClick"
                                Style="color: gren; color: blue;" 
                                Text="Visit Detail"></asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="LinkButton4" Visible="true" runat="server"
                                 Text="Travel Matrix Detail" Style="color: gren; color: blue;"
                        ...
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LnkDeatild_OnClick" Style="color: gren; color: blue;"
                                Text="Payment Hold Summary"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton11" runat="server" OnClick="LnkDeatild1_OnClick" Style="color: gren; color: blue;"
                                Text="TA/DA Claim Summary"></asp:LinkButton>
                        </li>
                          <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton13" runat="server" OnClick="LnkDeatildddd_OnClick" Style="color: gren; color: blue;"
                                Text="TA/DA Detail"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton14" runat="server" OnClick="LnkDeatildddd2_OnClick" Style="color: gren; color: blue;"
                                Text="Correction Log"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LnkFillingSystem_OnClick" Style="color: gren; color: blue;"
                                Text="Approval Status"></asp:LinkButton>
                        </li>

                         <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LnkReject_OnClick" Style="color: gren; color: blue;"
                                Text="Rejection Deatils"></asp:LinkButton>
                        </li>
                         <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton7" runat="server" OnClick="LnkFar_OnClick" Style="color: gren; color: blue;"
                                Text="Travel Fare"></asp:LinkButton>
                        </li>
                        <li class=" active li-width" runat="server" id="lnkR" visible="false">
                            <asp:LinkButton ID="LinkButton8" runat="server" OnClick="LnkFinr_OnClick" Style="color: gren; color: blue;"
                                Text="Finance Data Report"></asp:LinkButton>
                        </li>
                        <li class=" active li-width" runat="server" id="Li1" visible="false">
                            <asp:LinkButton ID="LinkButton9" runat="server" OnClick="LnkFinr2_OnClick" Style="color: gren; color: blue;"
                                Text="Finance Trend Report"></asp:LinkButton>
                        </li>
                    </ul>
                </div>
            </div>
                                                ...
                                                <ContentTemplate>
                                                    <div class="row">
                                                        <div class="col-sm-2 ">
                                                            ...
                                                            <label for="email" class="padd linhei" style="padding-top: 2px;">
                                                                Month</label>
                                                            <asp:DropDownList ID="ddlGender" OnSelectedIndexChanged="ddlGender_SelectedIndexChanged"
                                                                        AutoPostBack="true" runat="server" class="form-control ">
