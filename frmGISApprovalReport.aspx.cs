...
public partial class frmGISApprovalReport : System.Web.UI.Page
{
    ...
    public void LoadAnnualDataDeatilsHotSpot2024(int Flag)
    {
        ...
        DataSet dt = SqlHelper.GetDataSet(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptAnnaualPlanDataSummryDownloadFinal2024]", cmdParameters);
        // DataTable dt = objMain.LoadAnnaulPlanRowData(conditions, Flag);
    ...
    public void LoadAnnualDataDeatilsHotSpot(int Flag)
    {
        ...
        DataTable dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptApproveStausGis]", cmdParameters);
        // DataTable dt = objMain.LoadAnnaulPlanRowData(conditions, Flag);
    ...
    public void LoadAnnualSummary2024(int Flag)
    {
        ...
        DataSet dt = SqlHelper.GetDataSet(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptAnnalualPlan2024Summary]", cmdParameters);
        // DataTable dt = objMain.LoadAnnaulPlanRowData(conditions, Flag);
    ...
    public void LoadAnnualDataSummaryAlter2024(int Flag)
    {
        ...
        DataSet dt = SqlHelper.GetDataSet(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptClusterAnaulSummaryNewAlte2024]", cmdParameters);
