<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="frmActivitySummaryReport.aspx.cs" Inherits="frmActivitySummaryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-default " style="background-color: #f5f5f5; margin-bottom: 0px !important;">
                    <div class="panel-heading" style="padding: 5px 0px; margin-right: 15px;">
                        <div class="row">

                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Activity Summary Report
                                        </h3>
                                    </div>
                                </div>
        ...
        <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-12 text-left" style="padding-right: 0px; margin-top: 10px">
            <div style="margin-top: 0px; height: 598px;">
                <div class="thumbnail" style="height: 590PX;">

                    <ul style="margin: 0px">
                        <li class=" active li-width">
                            <asp:LinkButton ID="Button3" runat="server" OnClick="LnkAnnualPlan_OnClick" Style="color: gren; color: blue;" Text="SAC Quarter Update Status"></asp:LinkButton>
                        </li>
                        <li class=" active li-width">
                            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LnkAnnualPladdd_OnClick" Style="color: gren; color: blue;" Text="SAC Status-FC/BO/IO"></asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LnkAnnualPlanFC_OnClick" Style="color: gren; color: blue;" Text="SIP Target vs Achv"></asp:LinkButton>
                        </li>

                        <li>
                            <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LnkAnnualPlanFCrr_OnClick" Style="color: gren; color: blue;" Text="SAC Report"></asp:LinkButton>
                        </li>
                        ...
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2 " style="margin-bottom: 15px;">
                                                ...
                                                <asp:DropDownList ID="ddlTpye" OnSelectedIndexChanged="ddlTpye_SelectedIndexChanged" AutoPostBack="true" runat="server" class="form-control">
                                                    ...
                                                    <asp:ListItem Text="Submit(FC)" Value="1"></asp:ListItem>
                                                    <asp:ListItem Text="Approve(BO)" Value="2"></asp:ListItem>
                                                    <asp:ListItem Selected="True" Text="Approve(IO)" Value="3"></asp:ListItem>
                                                ...
                                                <asp:DropDownList ID="ddlGroup" runat="server" class="form-control">
                                                    ...
                                                    <asp:ListItem Value="3">School Wise</asp:ListItem>
                            ...
                            <div class="col-lg-12 table table-hover " style="padding: 0px;">
                                <asp:Panel ID="pnlMain" Enabled="true" runat="server">
                                    <div class="form-horizontal">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 6px 10px 0px 11px;">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="row" style="width: 100%">
                                                        <asp:GridView ID="GV_DynamicGrid" runat="server" OnPageIndexChanging="GV_DynamicGrid1_OnPageIndexChanging" ForeColor="Black" AllowPaging="true"
                                                            PageSize="100" ShowHeader="true" OnRowCreated="gvReportNew_RowCreated" Visible="false" CssClass="table table-striped table-bordered table-hover"
                                                            Width="100%">
                                                            <EmptyDataTemplate>
                                                            </EmptyDataTemplate>
