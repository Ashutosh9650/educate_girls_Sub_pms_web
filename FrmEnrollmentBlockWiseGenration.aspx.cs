...
public partial class FrmEnrollmentBlockWiseGenration : System.Web.UI.Page
{
    ...
    public void ReferPage()
    {
        ...
        if (Session["user_level"].ToString() == "39" || Session["user_level"].ToString() == "30" || Session["user_level"].ToString() == "136" || Session["user_level"].ToString() == "29")
        {
            #region Impact
   ...
   public void LoadDataBlock(string blockName)
    ...
    public DataTable LoadActivtiyAllClusterWise(string userName, string WhereQuery, Int32 Flag, string WhereQuery1)
    {
        ...
        return SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[LoadEnrollmentSealSineGenerationClusterBlockWise]", cmdParameters);
    }
    ...
    protected void OOD2Dtargetmet_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/FrmSealSign.aspx?ID=" + lblBlockCode + "," + lblClusterCode + "");
    ...
    public void LoadSerarchSchoolActivity()
    {
        ...
        if (Session["user_level"].ToString() == "39"  || Session["user_level"].ToString() == "29" || Session["user_level"].ToString() == "136")
        {
        ...
        {
            con = " mst5village.BlockCode IN(" + Session["blockCodeMul"].ToString() + ") ";
            con1 = " BlockCode IN(" + Session["blockCodeMul"].ToString() + ") ";
            dtMain = LoadActivtiyAllClusterWise(ddlBlock.SelectedValue, con, 1, con1);
           }
