...
public partial class Frm_CLT_Report : System.Web.UI.Page
{
    ...
    public void getreportBaseline()
    {
        ...
        else
        {
            if (ddlStatecode.Length > 0)
            {
                conditions += "  where   mst5Village.StateCode in(" + ddlStatecode + ") ";
    ...
    public void getGainReport()
    {
       ...
       new SqlParameter("@Con",  conditions),
        ...
        ///rptCltGainReporttest
        DataTable dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptCltGainReport]", parm);
        lblTotalCount.Text = dt.Rows.Count.ToString();
        ViewState["dt"] = (DataTable)dt;
        if (dt.Rows.Count > 0)
        {
    ...
    public void getreport()
    {
        ...
        if (ddlType.SelectedIndex > 0 && ddlDistrict.Length > 0)
        {
            if (ddlYear.SelectedIndex > 0)
            {
                conditions += "  where  mst5Village.Fyear = '" + ddlYear.SelectedItem.Text + "' ";
    ...
    protected void Learning_Click(object sender, EventArgs e)
    {
    ...
    public void LoadSchool()
    {
        ...
        if (ddlDistrict.Length > 0)
        {
            conditions += "  mst5Village.DistrictCode  in(" + ddlDistrict + ") ";
    ...
    protected void Report3_Click(object sender, EventArgs e)
    {
            ...
            if (ddlDistrict.Length > 0)
            {
                conditions += " where mst5Village.DistrictCode in(" + ddlDistrict + ") ";
    ...
    protected void DGV_GainReport_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        #region Basline Endline
            ...
            if (e.Row.RowType == DataControlRowType.Header)
            {
                    ...
                    HeaderCell = new TableCell();
                    HeaderCell.Text = "District Profile";
                    HeaderCell.HorizontalAlign = HorizontalAlign.Center;
                    ...
                    HeaderCell = new TableCell();
                    HeaderCell.Text = "# Students Assessed";
                    HeaderCell.HorizontalAlign = HorizontalAlign.Center;
                    ...
                    HeaderCell = new TableCell();
                    HeaderCell.Text = "Max Possible After Baseline";
                    HeaderCell.HorizontalAlign = HorizontalAlign.Center;
                    if (Convert.ToInt32(ddlType.SelectedValue) == 1)
                    {
                        HeaderCell.ColumnSpan = 3;
                    ...
                    HeaderCell = new TableCell();
                    HeaderCell.Text = "Gain in Endline";
                    HeaderCell.HorizontalAlign = HorizontalAlign.Center;
                    if (Convert.ToInt32(ddlType.SelectedValue) == 1)
                    {
                        HeaderCell.ColumnSpan = 3;
                    ...
                    HeaderCell = new TableCell();
                    HeaderCell.Text = "Gain/Max Possible After Baseline";
                    HeaderCell.HorizontalAlign = HorizontalAlign.Center;
                    ...
                    HeaderCell = new TableCell();
                    HeaderCell.Text = "Baseline Averege";
                    HeaderCell.HorizontalAlign = HorizontalAlign.Center;
                    if (Convert.ToInt32(ddlType.SelectedValue) == 1)
                    {
                        HeaderCell.ColumnSpan =3;
                    ...
                    HeaderCell = new TableCell();
                    HeaderCell.Text = "Endline Averege";
                    HeaderCell.HorizontalAlign = HorizontalAlign.Center;
                    if (Convert.ToInt32(ddlType.SelectedValue) == 1)
                    {
                        HeaderCell.ColumnSpan = 3;
    ...
    public void Export_To_Excel(object sender, EventArgs e)
    {
        ...
        else if (ViewState["Button"].ToString() == "Learning")
        {
            DataTable dt = ViewState["dt"] as DataTable;
