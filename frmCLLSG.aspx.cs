...
public partial class frmCLLSG : System.Web.UI.Page
{
    ...
    protected void LnkALGVnFC_OnClick(object sender, EventArgs e)
    {
        ViewState["1"] = 15;

        getChildRestration(1);




    }
    protected void LnkALAttC_OnClick(object sender, EventArgs e)
    {
        ViewState["1"] = 16;

        getChildRestrationAtt(1);




    }
    protected void Lnk5fffick(object sender, EventArgs e)
    {
        ViewState["1"] = 17;
    ...
    protected void Lnk5ffgggfick(object sender, EventArgs e)
    {
        ViewState["1"] = 18;
    ...
    protected void btnImport_Click(object sender, EventArgs e)
    {
        if (ViewState["1"].ToString() == "9" && Convert.ToString(ViewState["SAC"]) != "")
        {
            ...
            ExportToCSVFile(st, "CLLSGDetail");
           
        }
        if (ViewState["1"].ToString() == "10" && Convert.ToString(ViewState["SAC"]) != "")
        {
            DataTable st = ViewState["SAC"] as DataTable;
            ExportToCSVFile(st, "CLLSGSummary");
        ...
        {
            DataTable st = ViewState["SAC"] as DataTable;
            ExportToCSVFile(st, "CLLSGGirlsRegistration");

           
        }
        if (ViewState["1"].ToString() == "16" && Convert.ToString(ViewState["SAC"]) != "")
        {
            DataTable st = ViewState["SAC"] as DataTable;
            ExportToCSVFile(st, "CLLSGAttendance");

           
        }
        if (ViewState["1"].ToString() == "17" && Convert.ToString(ViewState["SAC"]) != "")
        {
            DataTable st = ViewState["SAC"] as DataTable;
            ExportToCSVFile(st, "CLLSGSummery");


        }
        if (ViewState["1"].ToString() == "18" && Convert.ToString(ViewState["SAC"]) != "")
        {
            DataTable st = ViewState["SAC"] as DataTable;
            ExportToCSVFile(st, "CLLSGAttendancesummary");
    ...
    public void getSACUpdateReport(Int32 Flag)
    {
        ...
        dtMain = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rpttblCLLSG]", cmdParameters);
        ...
        if (dtMain.Rows.Count > 0)
        {
            ...
            {
                ExportToCSVFile(dtMain, "CLLSGDetail");
            }
            else
            {
    ...
    public void getActivitySIPTargetvsAchv(Int32 Flag)
    {
        ...
        if (dtMain.Rows.Count > 0)
        {
            ...
            if (dtMain.Rows.Count > 500)
            {
                ExportToCSVFile(dtMain, "CLLSGSummary");
            }
            else
            {
                GV_DynamicGrid.Visible = true;
    ...
    public void getChildRestration(Int32 Flag)
    {
        ...
        dtMain = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptChildRegistrationLSG]", cmdParameters);
        ViewState["SAC"] = dtMain;
        if (dtMain.Rows.Count > 0)
        {
            //DataTable newDataTable = dtMain.Clone();
            ...
            if (dtMain.Rows.Count > 500)
            {
                ExportToCSVFile(dtMain, "CLLSGGirlsRegistration");
            }
            else
            {
                GV_DynamicGrid.Visible = true;
    ...
    public void getChildRestrationAtt(Int32 Flag)
    {
        ...
        dtMain = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptChildAttendenceLSG]", cmdParameters);
        ViewState["SAC"] = dtMain;
        if (dtMain.Rows.Count > 0)
        {
            //DataTable newDataTable = dtMain.Clone();
            ...
            if (dtMain.Rows.Count > 500)
            {
                ExportToCSVFile(dtMain, "CLLSGAttendance");
            }
            else
            {
                GV_DynamicGrid.Visible = true;
    ...
    public void getAttSummary(Int32 Flag)
    {
       ...
       new SqlParameter("@Flag", "3"),   
        ...
        if (dtMain.Rows.Count > 0)
        {
            ...
            if (dtMain.Rows.Count > 500)
            {
                ExportToCSVFile(dtMain, "CLLSGSummery");
            }
            else
            {
                GV_DynamicGrid.Visible = true;
    ...
    public void getAttSummaryMain(Int32 Flag)
    {
       ...
       new SqlParameter("@Flag", "4"),   
        ...
        if (dtMain.Rows.Count > 0)
        {
            ...
            if (dtMain.Rows.Count > 500)
            {
                ExportToCSVFile(dtMain, "CLLSGAttendancesummary");
            }
            else
            {
                GV_DynamicGrid.Visible = true;
