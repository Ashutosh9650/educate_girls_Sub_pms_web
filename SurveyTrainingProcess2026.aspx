<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" Culture="en-GB" AutoEventWireup="true" CodeFile="SurveyTrainingProcess2026.aspx.cs" Inherits="SurveyTrainingProcess2026" %>
<%--  --%>
...
.radioButtonList label
{
    ...
    <script type="text/javascript">
        ...
        function NewTabPreView() {
            ...
            if (Vdist.value == '2') {
                window.open(
                    "https://testpms.educategirls.ngo/SurveyAnspre.aspx?ID=" + panel.value + "", "_blank");
            }
            else {
                window.open(
                    "https://testpms.educategirls.ngo/SurveyAns2024.aspx?ID=" + panel.value + "", "_blank");
            }
        }
                                    ...
                                    <div class="panel-heading" style="padding: 6px 0px;">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                   ...
                                                   <div class="row">
                                                         <label class="col-sm-4  padd linhei"  style="font-size: 16px;">Training Scheduler </label>
                            <asp:DropDownList ID="ddlSchedue" Width="65%" AutoPostBack="true" 
                                runat="server" OnSelectedIndexChanged="ddlSchedue_SelectedIndexChanged" class="form-control ">
                            </asp:DropDownList>
