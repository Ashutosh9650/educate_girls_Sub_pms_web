<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmreportCVverification.aspx.cs" Inherits="frmreportCVverification" %>
                ...
                <div class="thumbnail" style="background-color: rgba(20, 18, 18, 0.59); float: left;">
                    ...
                    <ul class="nav navbar-nav" style="margin: 0px">
                        ...
                        <li class="active li-width" style = "width :247%;">
                            <asp:LinkButton ID="Button4" runat="server" Text="Verification" Style="color: white;"
