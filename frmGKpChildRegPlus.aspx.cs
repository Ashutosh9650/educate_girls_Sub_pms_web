...
public partial class frmGKpChildRegPlus : System.Web.UI.Page
{
    ...
    protected void LnkgkSummary_OnClick1(object sender, EventArgs e)
    {
        ViewState["1"] = 10770;

        LoadGKSUmmaryReport1(1);
        GVChildTarget.Visible = false;
        GVChild.Visible = false;
        GV_DynamicGrid.Visible = false;
    ...
    public void LoadChildEnrollment(int Flag)
    {
        ...
        if (Convert.ToInt32(ddlYear.SelectedValue) >= 2024)
        {
            ...
            dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptGKPchildRestraion2024Plus]", cmdParameters);
        }
    ...
    public void LoadGKSUmmaryReport(int Flag)
    {
        ...
        if (Convert.ToInt32(ddlYear.SelectedValue) >= 2024)
        {
            dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "rptGKPchildAttention2024PlusFormativeAssment", cmdParameters);
    ...
    public void LoadGKSUmmaryReport1(int Flag)
    {
        string conditions = "";
        string ddlBlock = "";
        string ddlDistrict = "";
        ...
        if (Convert.ToInt32(ddlYear.SelectedValue) >= 2024)
        {
            dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "rptGKPLsSummary", cmdParameters);
            ViewState["dt"] = dt;
            if (dt.Rows.Count > 0)
            {
    ...
    public void MultipuExeclProcess1()
    {
        ...
        wb = new XLWorkbook(StartupPath + "\\GKPPlusSummary.xlsx");
        ...
        filepath = StartupPath + "\\GKPPlusSummary " + "_" + System.DateTime.Now.ToString("hhssmmfff") + ".xlsx";
        wb.SaveAs(filepath);
    ...
    public void LoadExceptionReport(int Flag)
    {
        ...
        {
            dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "rptGKPchildAttention2024PlusAssment2025", cmdParameters);
        ...
        {
            dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "rptGKPchildAttention2024PlusAssment", cmdParameters);
    ...
    public void LoadFillSystem(int Flag)
    {
        ...
        if (Convert.ToInt32(ddlYear.SelectedValue) >= 2025)
        {
            //if (Convert.ToString(Session["username"]) == "SuperAdmin" || Convert.ToString(Session["username"]) == "PMSAdmin" || Convert.ToString(Session["username"]) == "EGE7557")
            //{
            dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "rptGKPchildAttention2024Plus2025", cmdParameters);
            //}
            //else
            //{
        ...
        else    if (Convert.ToInt32(ddlYear.SelectedValue) == 2024)
        {
            //if (Convert.ToString(Session["username"]) == "SuperAdmin" || Convert.ToString(Session["username"]) == "PMSAdmin" || Convert.ToString(Session["username"]) == "EGE7557")
            //{
            dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "rptGKPchildAttention2024Plus", cmdParameters);
            //}
            //else
            //{
            //    dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "rptGKPchildAttention2023", cmdParameters);
