...
public partial class frmFCPlannerTracker : System.Web.UI.Page
{
        ...
        public void LoadData()
    {
        ...
        if (ddlDistrict.Length > 0)
        {
            ...
            Con = " and mstuser.Villagecode in(" + ddlDistrict + ")";
        }
        ...
        SqlParameter[] parm1 = new SqlParameter[]
      {
        ...
        DataTable dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "rptTravelWeelllyReportMain", parm1);
        if (dt.Rows.Count > 0)
        {
            objComman.BindDLLMasterTable("mstSchool", "FromNo,FromNo1", dt, "", "Type", "asc", ddlGroup, "FromNo", "FromNo1", "Select");
    ...
    protected string GeneraatePDFMain()
    {
        ...
        try
        {
            ...
            string fno = ddlGroup.SelectedValue;
            ...
            SqlParameter[] parm1 = new SqlParameter[]
     {
         ...
         new SqlParameter("@FromNo",fno),
            ...
            if (Acount > 12)
            {
                sb += "  <table style=' width: 100%; border-spacing: 0; border-collapse: 0; margin-bottom: 15px; border: 0; font-size: 11px; ' border='1' > <tbody style='border: 0'> <tr style='border: 0'> <td colspan='2' style='border-right: 0'></td> <td colspan='15' style=' font-size: 26px; text-align: center; font-weight: 900; border-left: 0; padding: 15px; border-right: 0; ' > Foundation to Educate Girls Globally </td> <td colspan='2' style=' text-align: right; */border-left: 0; */border-left: 0; border-left: 0; ' > <img width='50%' height='40%' src='" + imageURLLogo + "'  alt=''  /> </td> </tr> ";
                sb += " <tr style='background: #fff2cc; border: 0'>";
                sb += " < td colspan='19' style='padding: 15px'> <table border='0' style=' border-spacing: 0; border-collapse: 0; border: 0; width: 100%; ' > <tbody>";
                ...
                sb += " < td>Cluster: <b>" + cluster + " </b></td> <td>Department: <b>Operations</b></td> <td>Department Code: <b></b>";
                ...
                sb += " < tr style='background: #ececec; font-size: 11px; border: 0'> " +
                   "<th style='width:6%'>Date from</th> " +
                   "<th style='width:5%'>Time In</th>" +
                   " <th style='width:6%'>Date To</th> " +
                   "<th style='width:5%'>Time Out</th>" +
                   " <th style='width:5%'>Travelling from</th>" +
               " < th style='width:5%'>Travelling to</th> " +
                "<th style='width:10%'>Purpose of Visit</th> " +
                "<th style='width:4%'>KM Within Cluster</th>" +
                " <th style='width:4%'>KM Outside Cluster</th> " +
                "<th style='width:5%'>Place of Accomm odation</th>" +
                  " < th style='width:5%'>Accommodation Payment Type</th>" +
                   " <th style='width:5%'>Accommodation Occupancy</th>" +
                   " <th style='width:5%'>Mode of Travel</th> " +
                   "<th style='width:5%'>Local Conveyance</th>" +
              " <th style='width:5%'>Accommodation Cost</th>" +
                   " <th>Per Diem</th> " +
                   "<th style='width:5%'>Travel Expenses</th> " +
                   "<th style='width:5%'>Others</th> " +
                   "<th style='width:5%'>Total</th> </tr> ";
                ...
                for (int i = 0; i < MainCount; i++)
                {
                    ...
                    sb += "<td style='width:6%'>" + dttravelmatrixdetails.Rows[i]["Fromdate"] + "</td>";
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["TimeIn"] + "</td>";
                    sb += "<td style='width:6%'>" + dttravelmatrixdetails.Rows[i]["Todate"] + "</td>";
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["Timeout"] + "</td>";
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["FromVillagename"] + "</td>";
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["ToVillagename"] + "</td>";
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["Objective"] + "</td>";
                    sb += "<td style='width:4%''>" + dttravelmatrixdetails.Rows[i]["ClusterKM"] + "</td>";
                    sb += "<td style='width:4%'>" + dttravelmatrixdetails.Rows[i]["ClusteroutKM"] + "</td>";
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["GuestHouseType"] + "</td>";
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["PaymentType"] + "</td>";
                    sb += "<td style='width:10%'>" + dttravelmatrixdetails.Rows[i]["Occupancy"] + "</td>";
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["TravelMode"] + "</td>";
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["Totalvehicle"] + "</td>";
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["GuestHouseRent"] + "</td>";
                    //Int32 DATA = Convert.ToInt32(dttravelmatrixdetails.Rows[i]["Total"]);
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["Perdim"] + "</td>";
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["TotalAmountAdmin"] + "</td>";
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["TotalExpensBO"] + "</td>";
                    sb += "<td style='width:5%'>" + dttravelmatrixdetails.Rows[i]["Total"] + "</td>";
                ...
                sb += "<tr style='border: 0'> <td colspan='18' style=' border-bottom: 1px solid #000000; text-align: right; padding-right: 15px; padding: 9px; font-weight: 900; font-size: 14px; ' > TOTAL REIMBURSEMENT </td> <td style='border-bottom: 1px solid #000000'>" + tot + "</td> </tr> </tbody> </table> ";
            ...
            sb += "<div style='page-break-before : always;'> </div>";
            sb += "< table style=' width: 100%; border-spacing: 0; border-collapse: 0; margin-bottom: 15px; border: 0; font-size: 11px; ' border='1' > <tbody style='border: 0'> <tr style='border: 0'> <td colspan='1' style='border-right: 0'></td> <td colspan='4' style=' font-size: 26px; text-align: center; font-weight: 900; border-left: 0; padding: 15px; border-right: 0; ' > Foundation to Educate Girls Globally </td> <td colspan='1' style=' text-align: right; */border-left: 0; */border-left: 0; border-left: 0; ' > <img width='50%' height='40%' src='" + imageURLLogo + "'  alt='' /> </td> </tr>";

            sb += "<tr style='background: #fff2cc; border: 0'> <td colspan='6' style='padding: 15px'>";
            ...
            sb += "<td style='padding-bottom: 15px'> District : <b>CHITRAKOOT</b> </td> </tr> </tbody> </table> ";
            ...
            sb += " <td>Department: <b>Operations</b></td> <td>Department Code: <b></b></td> ";
            ...
            sb += " <td>Form No: <b>" + fno + "</b></td> </tr> </tbody> </table> </td> </tr>";
            sb += " <tr> <th colspan='12' style=' font-weight: 900; font-size: 18px; padding: 9px; text-align: center; ' > Other Expens </th> </tr>";
            sb += " <tr>  ";
            sb += "<td  width='9%'>Date</td><td width='10%' >Local Travel in KM</td> <td  width='30%'>Description</td>";
            sb += " <td  width='10%'>Conveyance</td> <td  width='10%'>Others</td> ";
            sb += "<td  width='15%'>Remark</td> </tr> ";
            ...
            else
            {
                ...
                sb += "<td width='14%' valign='top'></td>";
                sb += "<td width='20%' valign='top'></td>";
                sb += "<td width='15%' valign='top'></td>";
                sb += "<td width='10%' valign='top'></td>";
                sb += "<td width='10%' valign='top'></td>";
                //sb+="<td width='14%' valign='top'>" + dttravelmatrixdetails.Rows[i]["DA"] + "</td>";
                sb += "<td width='15%' valign='top'></td>";
                //sb+="<td width='14%' valign='top'></td>";
            ...
            sb += " <td colspan='6' style=' text-align: center; background: #ececec; font-weight: 900; font-size: 18px; padding: 9px; ' > Approved Status </td> </tr> ";
            ...
            sb += "<tr> <td colspan='2'  style='vertical-align: bottom;border:solid black 0px;'>BO Approval:" + dttravelApprove.Rows[0]["BOApprovalStatus"].ToString() + "</td> <td colspan='2'  style='vertical-align: bottom;border:solid black 0px;'>Approved By: " + dttravelApprove.Rows[0]["BOApprovalBy"].ToString() + "</td> <td colspan='2'  style='vertical-align: bottom;border:solid black 0px;'>Approved By: " + dttravelApprove.Rows[0]["BOApprovalDate"].ToString() + "</td> </tr> ";
            sb += "<tr> <td colspan='2'  style='vertical-align: bottom;border:solid black 0px;'>Admin Approval: " + dttravelApprove.Rows[0]["AdminApprovalStatus"].ToString() + "</td> <td colspan='2'  style='vertical-align: bottom;border:solid black 0px;'>Approved By: " + dttravelApprove.Rows[0]["AdminApprovalBy"].ToString() + "</td> <td colspan='2'  style='vertical-align: bottom;border:solid black 0px;'>Approval Date: " + dttravelApprove.Rows[0]["AdminApprovalDate"].ToString() + "</td> </tr> ";
            ...
            sb += "<tr> <td colspan='2'  style='vertical-align: bottom;border:solid black 0px;'>DOL Verification: " + dttravelApprove.Rows[0]["DOLApprovalStatus"].ToString() + "</td> <td colspan='2'  style='vertical-align: bottom;border:solid black 0px;'>Verified By: " + dttravelApprove.Rows[0]["DOLApprovalBy"].ToString() + "</td> <td colspan='2'  style='vertical-align: bottom;border:solid black 0px;'>Verified Date: " + dttravelApprove.Rows[0]["DOLApprovalDate"].ToString() + "</td> </tr> ";
            sb += "<tr> <td colspan='2'  style='vertical-align: bottom;border:solid black 0px;'>Payment Status: " + dttravelApprove.Rows[0]["DOLApprovalStatus"].ToString() + "</td> <td colspan='2'  style='vertical-align: bottom;border:solid black 0px;'>Payment Processed by: " + dttravelApprove.Rows[0]["DOLApprovalBy"].ToString() + "</td> <td colspan='2'  style='vertical-align: bottom;border:solid black 0px;'>Payment Process Date:" + dttravelApprove.Rows[0]["DOLApprovalDate"].ToString() + "</td> </tr> ";
            ...
            {
                sb += "<div style='page-break-before : always;'> </div>";
                sb += "< table style=' width: 100%; border-spacing: 0; border-collapse: 0; margin-bottom: 15px; border: 0; font-size: 11px; ' border='1' > <tbody style='border: 0'> <tr style='border: 0'> <td colspan='1' style='border-right: 0'></td> <td colspan='4' style=' font-size: 26px; text-align: center; font-weight: 900; border-left: 0; padding: 15px; border-right: 0; ' > Foundation to Educate Girls Globally </td> <td colspan='1' style=' text-align: right; */border-left: 0; */border-left: 0; border-left: 0; ' > <img  alt='' width='50%' height='40%' src='" + imageURLLogo + "' /> </td> </tr>";
                ...
                sb += "<table border='0' style=' border-spacing: 0; border-collapse: 0; border: 0; width: 100%; ' > <tbody> <tr style='font-size: 11px'> ";
                sb += "<td style='font-size: 11px'>Block : <b>" + Block + "</b></td> <td>cluster <b>" + cluster + " </b></td>";
                sb += " <td>Department: <b>Operations</b></td> <td>Department Code: <b>1245</b></td> ";
                sb += "<td>Work Level: <b>L8</b></td> <td>Settlement Period: <b>" + dttraveDate.Rows[0]["Fdate"].ToString() + " TO " + dttraveDate.Rows[0]["Tdate"].ToString() + "</b></td>";
                sb += " <td>Form No: <b>" + fno + "</b></td> </tr> </tbody> </table> </td> </tr>";
    ...
    public void LoadChildSummaryDataTarget(int Flag)
    {
        ...
        if (Flag == 6)
        {
            ...
            if (ddlGroup.SelectedIndex > 0)
            {
                conditions += " and tblTravelMatrixDeatils2024AuditTrailRejection.FromNO ='" + ddlGroup.SelectedValue + "' ";
            }
       ...
       else if (Flag == 3)
        {
            ...
            if (ddlGroup.SelectedIndex > 0)
            {
                conditions += " and tblTravelMatrixApproveStatus.FromNO ='" + ddlGroup.SelectedValue + "' ";
            }
        }
        else
        {
            ...
            if (ddlGroup.SelectedIndex > 0)
            {
                conditions += " and tblTravelMatrixDeatils2024.FromNO ='" + ddlGroup.SelectedValue + "' ";
            }
            if (Convert.ToInt32(ddlGender.SelectedValue) > 0)
            {
                ...
                SqlParameter[] cmdParameters = new SqlParameter[]
       {
            ...
            new SqlParameter("@Con",conditions),
             ...
             new SqlParameter("@MYear",ddlYear.SelectedValue),
                ...
                dt = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "[rptTADACorrectionlog]", cmdParameters);
                if (dt.Rows.Count > 0)
                {
    ...
    public void LoadChildSummaryData(int Flag)
    {
        ...
        if (Session["FinYear"].ToString() == ddlYear.SelectedItem.Text)
        {
            ...
            {
                conditions += " and MstUser.StateCode in(" + ddlStatecode + ") ";
                condition5 += " and MstUser.StateCode in(" + ddlStatecode + ") ";
            ...
            if (ddlDistrict.Length > 0)
            {
                ...
                condition5 += " and MstUser.DistrictCode in(" + ddlDistrict + ") ";
            }
            if (ddlBlock.Length > 0)
            {

                conditions += " and BlockCode in(" + ddlBlock + ") ";
                condition5 += " and MstUser.BlockCode in(" + ddlBlock + ") ";
            }
            if (ddlPhan.Length > 0)
            {
                conditions += " and clustercode in(" + ddlPhan + ") ";
                condition5 += " and MstUser.Villagecode in(" + ddlPhan + ") ";
            }
        }
        else
        {
            if (ddlStatecode.Length > 0)
            {
                ...
                condition5 += " and MstUser2026.StateCode in(" + ddlStatecode + ") ";
            ...
            {
                conditions += " and DistrictCode in(" + ddlDistrict + ") ";
                condition5 += " and MstUser2026.DistrictCode in(" + ddlDistrict + ") ";
            }
            if (ddlBlock.Length > 0)
            {

                conditions += " and BlockCode in(" + ddlBlock + ") ";
                condition5 += " and MstUser2026.BlockCode in(" + ddlBlock + ") ";
            }
            if (ddlPhan.Length > 0)
            {
                conditions += " and clustercode in(" + ddlPhan + ") ";
                condition5 += " and MstUser2026.Villagecode in(" + ddlPhan + ") ";
            }
    ...
    public void LoadChildSmartPlaner(int Flag)
    {
        string conditions = "";
        string ddlBlock = "";
        string ddlDistrict = "";
        ...
        {
            conditions += " and MstUser.StateCode in(" + ddlStatecode + ") ";
            condition5 += " and StateCode in(" + ddlStatecode + ") ";
        ...
        {
            conditions += " and DistrictCode in(" + ddlDistrict + ") ";
            condition5 += " and DistrictCode in(" + ddlDistrict + ") ";
        }
        if (ddlBlock.Length > 0)
        {

            conditions += " and BlockCode in(" + ddlBlock + ") ";
            condition5 += " and BlockCode in(" + ddlBlock + ") ";
        }
        if (ddlPhan.Length > 0)
        {
            conditions += " and clustercode in(" + ddlPhan + ") ";
            condition5 += " and Uvillagecode in(" + ddlPhan + ") ";
        }
    ...
    public void MultipuExeclTrack(DataTable dt)
    {
        ...
        string filepath = "";
        XLWorkbook wb = new XLWorkbook();
        wb = new XLWorkbook(StartupPath + "\\ActivityPlanvsAchv.xlsx");
        var ws = wb.Worksheet(1);
        //var ws1 = wb.Worksheet(2);
        //var ws3 = wb.Worksheet(3);
        ...
        filepath = StartupPath + "\\ActivityPlanvsAchv " + "_" + System.DateTime.Now.ToString("hhssmmfff") + ".xlsx";
        wb.SaveAs(filepath);
        Response.ContentType = ContentType;
        Response.AppendHeader("Content-Disposition", "attachment; filename=" + Path.GetFileName(filepath));
        Response.WriteFile(filepath);
