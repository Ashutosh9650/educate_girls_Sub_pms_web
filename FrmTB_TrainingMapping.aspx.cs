...
public partial class FrmTB_TrainingMapping : System.Web.UI.Page
{
    ...
    public void LoadData()
    {
        ...
        if (ddlTraining.SelectedValue == "T")
        {
            ...
            DataTable dt1 = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "SP_GET_Tbl_PhaseMapping", p1);
            if (dt1.Rows.Count > 0)
            {
                ...
                SqlParameter[] p = new SqlParameter[]
            {
               ...
               new SqlParameter("@Con",  conditions),
                ...
                dt1 = SqlHelper.GetDataTable(SqlHelper.mainConnectionString, CommandType.StoredProcedure, "SP_GET_Tbl_PhaseMapping", p);
                gvnroll.DataSource = dt1;
                gvnroll.DataBind();
                gvnroll.Columns[1].Visible = false;
                gvnroll.Columns[2].Visible = false;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            for (int i = 0; i < gvnroll.Rows.Count; i++)
            {
                ...
                Ret = Insert_Update_TB_Staff_Taining(UniqueID, lblStateCode, lblDistrictCode, LearningID, OutcomeID, TxtN_P1_Y1, TxtN_P1_Y2, TxtN_P1_Y3, TxtN_P2_Y1, TxtN_P2_Y2, TxtN_P2_Y3, TxtN_P3_Y1, TxtN_P3_Y2, TxtN_P3_Y3, Flag, TxtN_P4_Y2, TxtN_P4_Y3);
    ...
    {
        ExportExcel((ddlTraining.SelectedItem.Text).Replace(" ", "") + "_", Session["ExcelExport"] as DataTable);
    ...
    public int Insert_Update_TB_Staff_Taining(string TB_GUID, Label lblStateCode, Label lblDistrictCode, Label lblLearningID, Label lblOutComeID, TextBox TxtN_P1_Y1, TextBox TxtN_P1_Y2, TextBox TxtN_P1_Y3, TextBox TxtN_P2_Y1, TextBox TxtN_P2_Y2, TextBox TxtN_P2_Y3, TextBox TxtN_P3_Y1, TextBox TxtN_P3_Y2, TextBox TxtN_P3_Y3, string Flag, TextBox TxtN_P4_Y2, TextBox TxtN_P4_Y3)
    {
        SqlConnection dbSqlconnection = new SqlConnection(SqlHelper.mainConnectionString);
        try
        {
            ...
            using (SqlCommand dbSqlCommand = (SqlCommand)dbSqlconnection.CreateCommand())
            {
                ...
                dbSqlCommand.Parameters.AddWithValue("@TB_GUID", TB_GUID);
                dbSqlCommand.Parameters.AddWithValue("@StateCode", Convert.ToString(lblStateCode.Text));
                dbSqlCommand.Parameters.AddWithValue("@DistrictCode", Convert.ToString(lblDistrictCode.Text));
                ...
                dbSqlCommand.Parameters.AddWithValue("@N_P1_Y2", TxtN_P1_Y2.Text == "" ? 0 : Convert.ToInt32(TxtN_P1_Y2.Text));
                dbSqlCommand.Parameters.AddWithValue("@N_P1_Y3", TxtN_P1_Y3.Text == "" ? 0 : Convert.ToInt32(TxtN_P1_Y3.Text));
                dbSqlCommand.Parameters.AddWithValue("@N_P2_Y1", TxtN_P2_Y1.Text == "" ? 0 : Convert.ToInt32(TxtN_P2_Y1.Text));
                dbSqlCommand.Parameters.AddWithValue("@N_P2_Y2", TxtN_P2_Y2.Text == "" ? 0 : Convert.ToInt32(TxtN_P2_Y2.Text));
                dbSqlCommand.Parameters.AddWithValue("@N_P2_Y3", TxtN_P2_Y3.Text == "" ? 0 : Convert.ToInt32(TxtN_P2_Y3.Text));
                dbSqlCommand.Parameters.AddWithValue("@N_P3_Y1", TxtN_P3_Y1.Text == "" ? 0 : Convert.ToInt32(TxtN_P3_Y1.Text));
                dbSqlCommand.Parameters.AddWithValue("@N_P3_Y2", TxtN_P3_Y2.Text == "" ? 0 : Convert.ToInt32(TxtN_P3_Y2.Text));
                dbSqlCommand.Parameters.AddWithValue("@N_P3_Y3", TxtN_P3_Y3.Text == "" ? 0 : Convert.ToInt32(TxtN_P3_Y3.Text));
                ...
                dbSqlCommand.Parameters.AddWithValue("@N_P4_Y2", TxtN_P4_Y2.Text == "" ? 0 : Convert.ToInt32(TxtN_P4_Y2.Text));
                dbSqlCommand.Parameters.AddWithValue("@N_P4_Y3", TxtN_P4_Y3.Text == "" ? 0 : Convert.ToInt32(TxtN_P4_Y3.Text));
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (ddlTraining.SelectedValue == "T")
                {
                    ...
                    HttpContext.Current.Response.Write("<td colspan='10' ' style='text-align:Center;border:.2pt solid windowtext;'>TB Training </td>");
                    HttpContext.Current.Response.Write("</tr>");
                    HttpContext.Current.Response.Write("<tr>");
                    HttpContext.Current.Response.Write("<td  rowspan='2' style='text-align:Center;border:.2pt solid windowtext;'> Training Outcome  </td>");
                    HttpContext.Current.Response.Write("<td colspan='9' style='text-align:Center;border:.2pt solid windowtext;'> No. of Trainings  </td>");
                    HttpContext.Current.Response.Write("</tr>");
                    HttpContext.Current.Response.Write("<tr>");
                    HttpContext.Current.Response.Write("<td colspan='3' style='text-align:Center;border:.2pt solid windowtext;'> Phase 1  </td>");
                    HttpContext.Current.Response.Write("<td colspan='2' style='text-align:Center;border:.2pt solid windowtext;'> Phase 2  </td>");
                    HttpContext.Current.Response.Write("<td colspan='2' style='text-align:Center;border:.2pt solid windowtext;'> Phase 3  </td>");
                    HttpContext.Current.Response.Write("<td colspan='2' style='text-align:Center;border:.2pt solid windowtext;'> Phase 4  </td>");
                    HttpContext.Current.Response.Write("</tr>");
                    HttpContext.Current.Response.Write("<tr>");
                ...
                {
                    HttpContext.Current.Response.Write("<tr>");
                    HttpContext.Current.Response.Write("<td colspan='11' ' style='text-align:Center;border:.2pt solid windowtext;'>Staff Training </td>");
                    HttpContext.Current.Response.Write("</tr>");
                    HttpContext.Current.Response.Write("<tr>");
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    HttpContext.Current.Response.Write("<td style='" + RowStyle + "'>" + dt.Rows[i]["N_P1_Y2"] + "</td>");
                    HttpContext.Current.Response.Write("<td style='" + RowStyle + "'>" + dt.Rows[i]["N_P1_Y3"] + "</td>");
                    HttpContext.Current.Response.Write("<td style='" + RowStyle + "'>" + dt.Rows[i]["N_P2_Y1"] + "</td>");
                    HttpContext.Current.Response.Write("<td style='" + RowStyle + "'>" + dt.Rows[i]["N_P2_Y2"] + "</td>");
                    HttpContext.Current.Response.Write("<td style='" + RowStyle + "'>" + dt.Rows[i]["N_P3_Y1"] + "</td>");
                    HttpContext.Current.Response.Write("<td style='" + RowStyle + "'>" + dt.Rows[i]["N_P3_Y2"] + "</td>");
                    HttpContext.Current.Response.Write("<td style='" + RowStyle + "'>" + dt.Rows[i]["N_P4_Y2"] + "</td>");
                    HttpContext.Current.Response.Write("<td style='" + RowStyle + "'>" + dt.Rows[i]["N_P4_Y3"] + "</td>");
                    HttpContext.Current.Response.Write("</tr>");
                }
