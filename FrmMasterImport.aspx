<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="FrmMasterImport.aspx.cs" Inherits="FrmMasterImport" %>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                <div id="Div2" class="col-lg-10 col-md-2 col-sm-3 cpl-xs-12" runat="server">
                                    <div class="">
                                        <h3 class="text-danger" style="margin: 0px;">Import Master Data
                                        </h3>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 cpl-xs-12">
                                ...
                                <asp:Button ID="Button1" runat="server" Text="Export format" OnClick="btnNewImport_Click" CssClass="btn-danger btn-sm" />
                                 <asp:Button ID="Button2" runat="server" Text="Delete" OnClick="btnNewImport1_Click" CssClass="btn-danger btn-sm" />
                        ...
                        <div class="panel-heading" style="padding: 10px 0px;">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <asp:Button ID="btnImport" runat="server" Text="Import" CssClass="btn-danger btn-sm" OnClick="btnImport_Click" />
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <asp:Button ID="btnApprove" runat="server" Text="Approve" CssClass="btn-danger" Visible="false"
                                            OnClick="btnApprove_Click" />
                                        <asp:LinkButton ID="LnkExport" runat="server" Visible="false" Text="Export format" CssClass="pull-right"
